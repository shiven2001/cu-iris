...
public:
    ...
    {
        ExportCloudsDialog->setWindowTitle(QApplication::translate("ExportCloudsDialog", "Export 3D Clouds", nullptr));
        checkBox_cameraProjection->setText(QString());
        label_12->setText(QApplication::translate("ExportCloudsDialog", "Reconstruction flavor.", nullptr));
        checkBox_filtering->setText(QString());
        checkBox_regenerate->setText(QString());
        label_binaryFile_12->setText(QApplication::translate("ExportCloudsDialog", "Meshing.", nullptr));
        label_binaryFile_9->setText(QApplication::translate("ExportCloudsDialog", "Cloud filtering.", nullptr));
        label_normal_2->setText(QApplication::translate("ExportCloudsDialog", "Set the search radius for the normal estimation.", nullptr));
        checkBox_meshing->setText(QString());
        label_gainCompensation->setText(QApplication::translate("ExportCloudsDialog", "Gain compensation. Normalize brightness of images.", nullptr));
        label_frame->setText(QApplication::translate("ExportCloudsDialog", "Output frame.", nullptr));
        checkBox_assemble->setText(QString());
        checkBox_binary->setText(QString());
        label_normal->setText(QApplication::translate("ExportCloudsDialog", "Set the number of k nearest neighbors to use for the normal estimation. Set 0 to disable.", nullptr));
        label_binaryFile_11->setText(QApplication::translate("ExportCloudsDialog", "From RGB-D images. If not checked, clouds will be generated from laser scans.", nullptr));
        doubleSpinBox_voxelSize_assembled->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        checkBox_fromDepth->setText(QString());
        checkBox_smoothing->setText(QString());
        comboBox_pipeline->setItemText(0, QApplication::translate("ExportCloudsDialog", "Organized Point Cloud", nullptr));
        comboBox_pipeline->setItemText(1, QApplication::translate("ExportCloudsDialog", "Dense Point Cloud", nullptr));

        label_smoothing->setText(QApplication::translate("ExportCloudsDialog", "Cloud smoothing using Moving Least Squares algorithm (MLS).", nullptr));
        label_intensityColormap->setText(QApplication::translate("ExportCloudsDialog", "Intensity colormap.", nullptr));
        label_voxel->setText(QApplication::translate("ExportCloudsDialog", "Voxel size. Set 0 to disable. When organized meshes are assembled, this is the radius in which the vertices of the polygons are merged.", nullptr));
        comboBox_intensityColormap->setItemText(0, QApplication::translate("ExportCloudsDialog", "GrayScale", nullptr));
        comboBox_intensityColormap->setItemText(1, QApplication::translate("ExportCloudsDialog", "RedYellow", nullptr));
        comboBox_intensityColormap->setItemText(2, QApplication::translate("ExportCloudsDialog", "Rainbow", nullptr));

        label_cameraProjection->setText(QApplication::translate("ExportCloudsDialog", "Camera projection. This can be used to colorize point cloud created from scans and/or export camera IDs for each point of the cloud.", nullptr));
        label_binaryFile_10->setText(QApplication::translate("ExportCloudsDialog", "Nodes filtering. Filter nodes to be exported in a specified region .", nullptr));
        comboBox_frame->setItemText(0, QApplication::translate("ExportCloudsDialog", "Map", nullptr));
        comboBox_frame->setItemText(1, QApplication::translate("ExportCloudsDialog", "Robot", nullptr));
        comboBox_frame->setItemText(2, QApplication::translate("ExportCloudsDialog", "Camera", nullptr));
        comboBox_frame->setItemText(3, QApplication::translate("ExportCloudsDialog", "Scan", nullptr));

        checkBox_gainCompensation->setText(QString());
        label_voxel_2->setText(QApplication::translate("ExportCloudsDialog", "Number of samples to keep, done with a random sample filter. Only used when clouds are assembled. Set 0 to disable.", nullptr));
        label_binaryFile->setText(QApplication::translate("ExportCloudsDialog", "Binary file (for ply and pcd outputs).", nullptr));
        label_regenerate->setText(QApplication::translate("ExportCloudsDialog", "Regenerate clouds. This can be used to regenerate the point clouds at higher density than those used for online visualization.", nullptr));
        checkBox_nodes_filtering->setText(QString());
        label_binaryFile_2->setText(QApplication::translate("ExportCloudsDialog", "Assemble clouds/meshes to a single output cloud/mesh.", nullptr));
        label_normal_3->setText(QApplication::translate("ExportCloudsDialog", "Flip ground normals up if close to -z axis. Set to 0.9 to begin with, increase to limit normals very close to -z axis. Set 0 to disable.", nullptr));
        groupBox_nodes_filtering->setTitle(QApplication::translate("ExportCloudsDialog", "Nodes Filtering", nullptr));
        label_114->setText(QApplication::translate("ExportCloudsDialog", "Set min and max range values on each axis. Nodes inside those ranges will be exported. If the min and max are equals, there is no filtering on that axis. For example for 2D map, set Z min and Z max to 0. To filter just in altitude, set only Z ranges.", nullptr));
        label_113->setText(QApplication::translate("ExportCloudsDialog", "X max", nullptr));
#ifndef QT_NO_TOOLTIP
        label_142->setToolTip(QApplication::translate("ExportCloudsDialog", "Length along X-Axis", nullptr));
#endif // QT_NO_TOOLTIP
        label_142->setText(QApplication::translate("ExportCloudsDialog", "Y min", nullptr));
        doubleSpinBox_nodes_filtering_ymin->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
#ifndef QT_NO_TOOLTIP
        label_115->setToolTip(QApplication::translate("ExportCloudsDialog", "Width along Y-Axis", nullptr));
#endif // QT_NO_TOOLTIP
        label_115->setText(QApplication::translate("ExportCloudsDialog", "Y max", nullptr));
#ifndef QT_NO_TOOLTIP
        label_116->setToolTip(QApplication::translate("ExportCloudsDialog", "Height along Z-Axis", nullptr));
#endif // QT_NO_TOOLTIP
        label_116->setText(QApplication::translate("ExportCloudsDialog", "Z min", nullptr));
#ifndef QT_NO_TOOLTIP
        label_119->setToolTip(QApplication::translate("ExportCloudsDialog", "Width along Y-Axis", nullptr));
#endif // QT_NO_TOOLTIP
        label_119->setText(QApplication::translate("ExportCloudsDialog", "Z max", nullptr));
        label_111->setText(QApplication::translate("ExportCloudsDialog", "X min", nullptr));
        doubleSpinBox_nodes_filtering_xmin->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_nodes_filtering_xmax->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_nodes_filtering_zmin->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_nodes_filtering_ymax->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_nodes_filtering_zmax->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        groupBox_regenerateScans->setTitle(QApplication::translate("ExportCloudsDialog", "Regenerate Scans", nullptr));
        label_109->setText(QApplication::translate("ExportCloudsDialog", "Downsampling step.", nullptr));
        label_138->setText(QApplication::translate("ExportCloudsDialog", "Minimum range.", nullptr));
        doubleSpinBox_rangeMin->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_rangeMax->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_139->setText(QApplication::translate("ExportCloudsDialog", "Maximum range (0 means no limit).", nullptr));
        groupBox_regenerate->setTitle(QApplication::translate("ExportCloudsDialog", "Regenerate Clouds", nullptr));
        label_134->setText(QApplication::translate("ExportCloudsDialog", "Path to a depth distortion model to apply (output from depth calibration).", nullptr));
        label_135->setText(QApplication::translate("ExportCloudsDialog", "ROI ratios [left, right, top, bottom] between 0 and 1. Only generate 3D points for pixels inside the region of interest (RGB image).", nullptr));
        doubleSpinBox_maxDepth->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_198->setText(QApplication::translate("ExportCloudsDialog", "Fill depth hole error.", nullptr));
        doubleSpinBox_minDepth->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_108->setText(QApplication::translate("ExportCloudsDialog", "3D cloud decimation (1-2-4-8-...). Negative decimation is done from RGB size instead of depth size (if depth is smaller than RGB, it may be interpolated depending of the decimation value).", nullptr));
        checkBox_subtraction->setText(QString());
        label_137->setText(QApplication::translate("ExportCloudsDialog", "Cloud subtraction. Superposed points from different nodes are filtered.", nullptr));
        label_197->setText(QApplication::translate("ExportCloudsDialog", "Fill depth hole size (0 means no fill).", nullptr));
        label_132->setText(QApplication::translate("ExportCloudsDialog", "3D cloud maximum depth (0 means no limit).", nullptr));
        spinBox_fillDepthHolesError->setSuffix(QApplication::translate("ExportCloudsDialog", " %", nullptr));
        toolButton_distortionModel->setText(QApplication::translate("ExportCloudsDialog", "...", nullptr));
        checkBox_bilateral->setText(QString());
        label_133->setText(QApplication::translate("ExportCloudsDialog", "3D cloud minimum depth.", nullptr));
        label_136->setText(QApplication::translate("ExportCloudsDialog", "Bilateral filtering of the depth image. Reduce noise in depth images.", nullptr));
        spinBox_fillDepthHoles->setSuffix(QApplication::translate("ExportCloudsDialog", " pixels", nullptr));
        groupBox_bilateral->setTitle(QApplication::translate("ExportCloudsDialog", "Bilateral Filtering of the Depth Image", nullptr));
        doubleSpinBox_bilateral_sigmaR->setSuffix(QString());
        label_194->setText(QApplication::translate("ExportCloudsDialog", "Standard deviation of the Gaussian for the intensity difference. Set the standard deviation of the Gaussian used to control how much an adjacent pixel is downweighted because of the intensity difference (depth in our case).", nullptr));
        doubleSpinBox_bilateral_sigmaS->setSuffix(QString());
        label_195->setText(QApplication::translate("ExportCloudsDialog", "Size of the Gaussian bilateral filter window to use. Set the standard deviation of the Gaussian used by the bilateral filter for the spatial neighborhood/window.", nullptr));
        groupBox_subtraction->setTitle(QApplication::translate("ExportCloudsDialog", "Cloud Subtraction", nullptr));
        label_174->setText(QApplication::translate("ExportCloudsDialog", "Minimum points of the previous cloud in the fixed point radius in order to substract the point in the new cloud. Increasing this value reduces the black contours between clouds.", nullptr));
        label_193->setText(QApplication::translate("ExportCloudsDialog", "Point angle used to keep only points with similar normal between the current cloud and the previous one.", nullptr));
        doubleSpinBox_subtractPointFilteringRadius->setSuffix(QString());
        label_192->setText(QApplication::translate("ExportCloudsDialog", "Point radius used to find close points between the current cloud and the previous one.", nullptr));
        doubleSpinBox_subtractPointFilteringAngle->setSuffix(QApplication::translate("ExportCloudsDialog", " degrees", nullptr));
        groupBox_filtering->setTitle(QApplication::translate("ExportCloudsDialog", "Cloud Filtering", nullptr));
        doubleSpinBox_floorHeight->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_filteringRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_144->setText(QApplication::translate("ExportCloudsDialog", "Footprint length.", nullptr));
        doubleSpinBox_footprintWidth->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_footprintLength->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_145->setText(QApplication::translate("ExportCloudsDialog", "Footprint height. If negative, the footprint is filtered between [-height:height] around the base frame, otherwise it is [0:height]", nullptr));
        doubleSpinBox_ceilingHeight->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_141->setText(QApplication::translate("ExportCloudsDialog", "Floor filtering height. This is done in map frame.", nullptr));
        label_110->setText(QApplication::translate("ExportCloudsDialog", "Search radius.", nullptr));
        label_143->setText(QApplication::translate("ExportCloudsDialog", "Footprint width.", nullptr));
        doubleSpinBox_footprintHeight->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_112->setText(QApplication::translate("ExportCloudsDialog", "Minimum neighbors in the search radius.", nullptr));
        label_140->setText(QApplication::translate("ExportCloudsDialog", "Ceiling filtering height. This is done in map frame.", nullptr));
        groupBox_offAxisFiltering->setTitle(QApplication::translate("ExportCloudsDialog", "Off-Axis Filtering", nullptr));
        label_148->setText(QApplication::translate("ExportCloudsDialog", "Keep only points with normals aligned with one/any of the map X-Y-Z axes.", nullptr));
        checkBox_offAxisFilteringPosX->setText(QApplication::translate("ExportCloudsDialog", "+X", nullptr));
        checkBox_offAxisFilteringNegY->setText(QApplication::translate("ExportCloudsDialog", "-Y", nullptr));
        checkBox_offAxisFilteringNegX->setText(QApplication::translate("ExportCloudsDialog", "-X", nullptr));
        checkBox_offAxisFilteringPosY->setText(QApplication::translate("ExportCloudsDialog", "+Y", nullptr));
        checkBox_offAxisFilteringPosZ->setText(QApplication::translate("ExportCloudsDialog", "+Z", nullptr));
        checkBox_offAxisFilteringNegZ->setText(QApplication::translate("ExportCloudsDialog", "-Z", nullptr));
        doubleSpinBox_offAxisFilteringAngle->setSuffix(QApplication::translate("ExportCloudsDialog", " deg", nullptr));
        label_146->setText(QApplication::translate("ExportCloudsDialog", "Max angle error to keep the points. ", nullptr));
        groupBox_mls->setTitle(QApplication::translate("ExportCloudsDialog", "Cloud Smoothing", nullptr));
        label->setText(QApplication::translate("ExportCloudsDialog", "WARNING: This adds significative time to process, though the clouds will be more smooth.", nullptr));
        doubleSpinBox_mlsRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        comboBox_upsamplingMethod->setItemText(0, QApplication::translate("ExportCloudsDialog", "NONE", nullptr));
        comboBox_upsamplingMethod->setItemText(1, QApplication::translate("ExportCloudsDialog", "DISTINCT_CLOUD", nullptr));
        comboBox_upsamplingMethod->setItemText(2, QApplication::translate("ExportCloudsDialog", "SAMPLE_LOCAL_PLANE", nullptr));
        comboBox_upsamplingMethod->setItemText(3, QApplication::translate("ExportCloudsDialog", "RANDOM_UNIFORM_DENSITY", nullptr));
        comboBox_upsamplingMethod->setItemText(4, QApplication::translate("ExportCloudsDialog", "VOXEL_GRID_DILATION", nullptr));
...
"Guidelines: 4 times the voxel size, 0.025 for voxel=0.", nullptr));
        label_88->setText(QApplication::translate("ExportCloudsDialog", "Upsampling method.", nullptr));
        label_89->setText(QApplication::translate("ExportCloudsDialog", "Polygonial order. Sets whether the surface and normal are approximated using a polynomial, or only via tangent estimation (value=0).", nullptr));
        label_90->setText(QApplication::translate("ExportCloudsDialog", "Output voxel size. Used to filter superposed points after upsampling.", nullptr));
        groupBox->setTitle(QApplication::translate("ExportCloudsDialog", "NONE", nullptr));
        label_2->setText(QApplication::translate("ExportCloudsDialog", "No upsampling will be done, only the input points will be projected to their own MLS surfaces.", nullptr));
        groupBox_2->setTitle(QApplication::translate("ExportCloudsDialog", "DISTINCT_CLOUD", nullptr));
        label_3->setText(QApplication::translate("ExportCloudsDialog", "Will project the points of the distinct cloud to the closest point on the MLS surface.", nullptr));
        groupBox_3->setTitle(QApplication::translate("ExportCloudsDialog", "SAMPLE_LOCAL_PLANE", nullptr));
        label_4->setText(QApplication::translate("ExportCloudsDialog", "The local plane of each input point will be sampled in a circular fashion.", nullptr));
        label_8->setText(QApplication::translate("ExportCloudsDialog", "Set the step size for the local plane sampling.", nullptr));
        label_7->setText(QApplication::translate("ExportCloudsDialog", "Set the radius of the circle in the local point plane that will be sampled.", nullptr));
        groupBox_4->setTitle(QApplication::translate("ExportCloudsDialog", "RANDOM_UNIFORM_DENSITY", nullptr));
        label_5->setText(QApplication::translate("ExportCloudsDialog", "The local plane of each input point will be sampled using an uniform random distribution such that the density of points is constant throughout the cloud.", nullptr));
        label_9->setText(QApplication::translate("ExportCloudsDialog", "Set the parameter that specifies the desired number of points within the search radius.", nullptr));
        groupBox_5->setTitle(QApplication::translate("ExportCloudsDialog", "VOXEL_GRID_DILATION", nullptr));
        ...
        label_10->setText(QApplication::translate("ExportCloudsDialog", "Set the voxel size for the voxel grid.", nullptr));
        label_11->setText(QApplication::translate("ExportCloudsDialog", "Set the number of dilation steps of the voxel grid.", nullptr));
        groupBox_gain->setTitle(QApplication::translate("ExportCloudsDialog", "Gain Compensation", nullptr));
        doubleSpinBox_gainBeta->setSuffix(QString());
        label_binaryFile_7->setText(QApplication::translate("ExportCloudsDialog", "Do full compensation between all locations (longer to do but quality is better). Otherwise, compensation is done only between linked locations.", nullptr));
        doubleSpinBox_gainOverlap->setSuffix(QString());
        checkBox_gainFull->setText(QString());
        label_binaryFile_3->setText(QApplication::translate("ExportCloudsDialog", "Correspondence radius", nullptr));
        label_binaryFile_5->setText(QApplication::translate("ExportCloudsDialog", "Beta. The lower, the higher the compensation is but images are darker. When texturing, brightness and contrast balance below can be activated to re-increase brightness (e.g., set high ratio to 20%).", nullptr));
        doubleSpinBox_gainRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_binaryFile_6->setText(QApplication::translate("ExportCloudsDialog", "Min overlap (%)", nullptr));
        label_binaryFile_8->setText(QApplication::translate("ExportCloudsDialog", "Gain on each RGB channel separatly.", nullptr));
        checkBox_gainRGB->setText(QString());
        groupBox_cameraProjection->setTitle(QApplication::translate("ExportCloudsDialog", "Camera Projection", nullptr));
        checkBox_camProjDistanceToCamPolicy->setText(QString());
        label_meshingTextureSize_16->setText(QApplication::translate("ExportCloudsDialog", "Decimation of camera resolution before projection. This can help to correctly estimate points hidden by other points, in case the point cloud is sparse.", nullptr));
        label_camProjExportCamera->setText(QApplication::translate("ExportCloudsDialog", "ID format of the camera selected for each point.", nullptr));
        label_meshingTextureSize_13->setText(QApplication::translate("ExportCloudsDialog", "Maximum distance from the camera for points to be colorized by this camera (0 means infinite).", nullptr));
        spinBox_camProjDecimation->setSuffix(QString());
        label_meshingTextureSize_17->setText(QApplication::translate("ExportCloudsDialog", "ROI ratios [left right top bottom] between 0 and 1. This can be used to ignore black borders of RGB images caused by calibration. ", nullptr));
        label_meshingTextureSize_12->setText(QApplication::translate("ExportCloudsDialog", "Maximum angle between camera and point's normal to apply color (0 means disabled).", nullptr));
        checkBox_camProjRecolorPoints->setText(QString());
        checkBox_camProjKeepPointsNotSeenByCameras->setText(QString());
        comboBox_camProjExportCamera->setItemText(0, QApplication::translate("ExportCloudsDialog", "Disabled", nullptr));
        comboBox_camProjExportCamera->setItemText(1, QApplication::translate("ExportCloudsDialog", "By Node ID", nullptr));
        comboBox_camProjExportCamera->setItemText(2, QApplication::translate("ExportCloudsDialog", "By Camera Index", nullptr));
        comboBox_camProjExportCamera->setItemText(3, QApplication::translate("ExportCloudsDialog", "By Node ID and Camera Index", nullptr));

#ifndef QT_NO_TOOLTIP
        comboBox_camProjExportCamera->setToolTip(QApplication::translate("ExportCloudsDialog", "By Node ID: cameras of same node have same ID\n"
"By Camera Index: of a multi-cameras setup\n"
"By Node ID and Camera Index: NodeID*10+CameraIndex", nullptr));
#endif // QT_NO_TOOLTIP
        label_meshingTextureSize_14->setText(QApplication::translate("ExportCloudsDialog", "Distance to camera policy. The closest camera from a point is used to colorize the point. If disabled, the camera for which the point projection is the closest of the image center is used to colorize the point.", nullptr));
        doubleSpinBox_camProjMaxAngle->setSuffix(QApplication::translate("ExportCloudsDialog", " deg", nullptr));
        doubleSpinBox_camProjMaxDistance->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_meshingTextureSize_15->setText(QApplication::translate("ExportCloudsDialog", "Keep points not seen by the cameras. These points will be set with a pure red color (255,0,0) if the cloud was created from laser scans.", nullptr));
        label_meshingTextureSize_18->setText(QApplication::translate("ExportCloudsDialog", "Recolor points from camera projection. This would be used to color laser scans with the cameras.", nullptr));
        label_meshingTextureSize_19->setText(QApplication::translate("ExportCloudsDialog", "File path for a mask. Format should be 8-bits grayscale. The mask should cover all cameras in case multi-camera is used and have the same resolution.", nullptr));
        toolButton_camProjMaskFilePath->setText(QApplication::translate("ExportCloudsDialog", "...", nullptr));
        groupBox_meshing->setTitle(QApplication::translate("ExportCloudsDialog", "Meshing", nullptr));
        label_meshClean->setText(QApplication::translate("ExportCloudsDialog", "Clean mesh from polygons without color or texture.", nullptr));
        ...
        label_meshDecimation_2->setText(QApplication::translate("ExportCloudsDialog", "Transferring color radius. Radius used to transfer color from original cloud to resampled reconstructed surface (e.g., Poisson or mesh decimation). Negative means disabled, 0 means take the nearest point.", nullptr));
        ...
        label_textureMapping->setText(QApplication::translate("ExportCloudsDialog", "Texture mapping. Images of the cameras will be projected on the mesh(es). Output is a *.obj format. Available on Export or when clouds are not assembled.", nullptr));
        comboBox_meshingApproach->setItemText(0, QApplication::translate("ExportCloudsDialog", "Fast GP3", nullptr));
        comboBox_meshingApproach->setItemText(1, QApplication::translate("ExportCloudsDialog", "Poisson", nullptr));
        comboBox_meshingApproach->setItemText(2, QApplication::translate("ExportCloudsDialog", "CPU-TSDF", nullptr));
        comboBox_meshingApproach->setItemText(3, QApplication::translate("ExportCloudsDialog", "Organized", nullptr));
        comboBox_meshingApproach->setItemText(4, QApplication::translate("ExportCloudsDialog", "Open Chisel (TSDF)", nullptr));

        checkBox_textureMapping->setText(QString());
        doubleSpinBox_transferColorRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        checkBox_cleanMesh->setText(QString());
        label_16->setText(QApplication::translate("ExportCloudsDialog", "Minimum polygon cluster size (-1 means that only the biggest cluster is kept).", nullptr));
        label_meshMaxPolygons->setText(QApplication::translate("ExportCloudsDialog", "Maximum polygons (0=no max). Another way to do mesh quadric decimation, the factor will be computed depending on the polygons generated.", nullptr));
        spinBox_meshMaxPolygons->setSuffix(QString());
        groupBox_textureMapping->setTitle(QApplication::translate("ExportCloudsDialog", "Texturing", nullptr));
        spinBox_textureBrightnessContrastRatioHigh->setSuffix(QApplication::translate("ExportCloudsDialog", " %", nullptr));
        label_meshingTextureSize_6->setText(QApplication::translate("ExportCloudsDialog", "Brightness and contrast balance high ratio. Only used when textures are merged.", nullptr));
        comboBox_blendingDecimation->setItemText(0, QApplication::translate("ExportCloudsDialog", "Auto", nullptr));
        comboBox_blendingDecimation->setItemText(1, QApplication::translate("ExportCloudsDialog", "1", nullptr));
        comboBox_blendingDecimation->setItemText(2, QApplication::translate("ExportCloudsDialog", "2", nullptr));
        comboBox_blendingDecimation->setItemText(3, QApplication::translate("ExportCloudsDialog", "4", nullptr));
        comboBox_blendingDecimation->setItemText(4, QApplication::translate("ExportCloudsDialog", "8", nullptr));
        comboBox_blendingDecimation->setItemText(5, QApplication::translate("ExportCloudsDialog", "16", nullptr));
        comboBox_blendingDecimation->setItemText(6, QApplication::translate("ExportCloudsDialog", "32", nullptr));
        comboBox_blendingDecimation->setItemText(7, QApplication::translate("ExportCloudsDialog", "64", nullptr));

        checkBox_blending->setText(QString());
        label_exposureFusion_3->setText(QApplication::translate("ExportCloudsDialog", "Blending decimation. ", nullptr));
        label_meshingTextureSize_7->setText(QApplication::translate("ExportCloudsDialog", "ROI ratios [left right top bottom] between 0 and 1. This can be used to ignore black borders of RGB images caused by calibration. ", nullptr));
        label_meshingTextureSize_8->setText(QApplication::translate("ExportCloudsDialog", "Maximum output textures.", nullptr));
        label_exposureFusion_2->setText(QApplication::translate("ExportCloudsDialog", "Blending. Only used with dense reconstruction flavor and if clouds are assembled.", nullptr));
        label_meshingTextureSize_2->setText(QApplication::translate("ExportCloudsDialog", "Maximum distance from the camera for polygons to be textured by this camera (0 means infinite). Only used with dense reconstruction flavor.", nullptr));
        doubleSpinBox_meshingTextureMaxDistance->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_meshingTextureSize_5->setText(QApplication::translate("ExportCloudsDialog", "Brightness and contrast balance low ratio. Only used when textures are merged.", nullptr));
        label_meshingTextureFormat->setText(QApplication::translate("ExportCloudsDialog", "Texture format.", nullptr));
        comboBox_meshingTextureFormat->setItemText(0, QApplication::translate("ExportCloudsDialog", ".jpg", nullptr));
        comboBox_meshingTextureFormat->setItemText(1, QApplication::translate("ExportCloudsDialog", ".png", nullptr));

        comboBox_meshingTextureSize->setItemText(0, QApplication::translate("ExportCloudsDialog", "Disabled", nullptr));
        comboBox_meshingTextureSize->setItemText(1, QApplication::translate("ExportCloudsDialog", "256x256", nullptr));
        comboBox_meshingTextureSize->setItemText(2, QApplication::translate("ExportCloudsDialog", "512x512", nullptr));
        comboBox_meshingTextureSize->setItemText(3, QApplication::translate("ExportCloudsDialog", "1024x1024", nullptr));
        comboBox_meshingTextureSize->setItemText(4, QApplication::translate("ExportCloudsDialog", "2048x2048", nullptr));
        comboBox_meshingTextureSize->setItemText(5, QApplication::translate("ExportCloudsDialog", "4096x4096", nullptr));
        comboBox_meshingTextureSize->setItemText(6, QApplication::translate("ExportCloudsDialog", "8192x8192", nullptr));
        comboBox_meshingTextureSize->setItemText(7, QApplication::translate("ExportCloudsDialog", "16384x16384", nullptr));
        comboBox_meshingTextureSize->setItemText(8, QApplication::translate("ExportCloudsDialog", "32768x32768", nullptr));

        checkBox_exposureFusion->setText(QString());
        label_meshingTextureSize_4->setText(QApplication::translate("ExportCloudsDialog", "Minimum polygon cluster size for texturing. This removes textures applied on sparse polygons. Only used with dense reconstruction flavor.", nullptr));
        label_meshingTextureSize->setText(QApplication::translate("ExportCloudsDialog", "Output texture size. If not set or when clouds are not assembled, all textures are saved separately. Warning: values higher than 2048 may not be compatible with all GPUs.", nullptr));
        checkBox_cameraFilter->setText(QString());
        spinBox_textureBrightnessContrastRatioLow->setSuffix(QApplication::translate("ExportCloudsDialog", " %", nullptr));
        label_meshingTextureSize_3->setText(QApplication::translate("ExportCloudsDialog", "Camera filtering. Some criteria to select which cameras are used for texturing.", nullptr));
        label_exposureFusion->setText(QApplication::translate("ExportCloudsDialog", "Exposure fusion. Only used when textures are merged and brightness/contrast balance ratios are used (merging original texture + 1 for each ratios).", nullptr));
        label_meshingTextureSize_9->setText(QApplication::translate("ExportCloudsDialog", "Maximum depth error between reconstructed mesh projection in camera and corresponding value in depth image to apply texturing (negative means disabled, 0 means that longest edge length of the face is used as maximum error).", nullptr));
        doubleSpinBox_meshingTextureMaxDepthError->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_meshingTextureSize_10->setText(QApplication::translate("ExportCloudsDialog", "Maximum angle between camera and face to apply texture (0 means disabled).", nullptr));
        doubleSpinBox_meshingTextureMaxAngle->setSuffix(QApplication::translate("ExportCloudsDialog", " deg", nullptr));
        label_multiband->setText(QApplication::translate("ExportCloudsDialog", "MultiBand texturing. Only available on export and RTAB-Map should be built with AliceVision support.", nullptr));
        checkBox_multiband->setText(QString());
        label_meshingTextureSize_11->setText(QApplication::translate("ExportCloudsDialog", "Distance to camera policy. The closest camera from a polygon is used to texture the polygon. If disabled, the camera for which the polygon projection is the closest of the image center is used to texture the polygon.", nullptr));
        checkBox_distanceToCamPolicy->setText(QString());
        groupBox_cameraFilter->setTitle(QApplication::translate("ExportCloudsDialog", "Camera Filtering", nullptr));
        doubleSpinBox_cameraFilterRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_37->setText(QApplication::translate("ExportCloudsDialog", "Only one camera in a fixed radius and angle is used for texturing. Radius of 0 m means disabled.", nullptr));
        doubleSpinBox_laplacianVariance->setSuffix(QString());
        doubleSpinBox_cameraFilterAngle->setSuffix(QApplication::translate("ExportCloudsDialog", " deg", nullptr));
        label_38->setText(QApplication::translate("ExportCloudsDialog", "Laplacian variance threshold. Below this threshold, the image is considered blurred. 0 means disabled. 50 can be good default.", nullptr));
        doubleSpinBox_cameraFilterVelRad->setSuffix(QApplication::translate("ExportCloudsDialog", " rad/s", nullptr));
        doubleSpinBox_cameraFilterVel->setSuffix(QApplication::translate("ExportCloudsDialog", " m/s", nullptr));
        label_39->setText(QApplication::translate("ExportCloudsDialog", "Maximum speed to keep a camera view for texturing. Images taken on fast motions would be more blurry. 0 means disabled. 0.1 m/s and 0.4 rad/s can be good defaults.", nullptr));
        groupBox_multiband->setTitle(QApplication::translate("ExportCloudsDialog", "MultiBand Texturing", nullptr));
        label_49->setText(QApplication::translate("ExportCloudsDialog", "Downscaling to 4 or 8 will reduce the texture quality but speed up the computation time. Set Texture Downscale to 1 instead of 2 to get the maximum possible resolution with the resolution of your images. The output texture size will be divided by this value, e.g., with texture size of 8192 and downscale value of 2, the output will be 4096.", nullptr));
        label_52->setText(QApplication::translate("ExportCloudsDialog", "Texture edge padding size in pixel.", nullptr));
        label_50->setText(QApplication::translate("ExportCloudsDialog", "Unwrap method: 0=basic (default, >600k faces, fast), 1=ABF (<=300k faces, generate 1 atlas), 2=LSCM (<=600k faces, optimize space).", nullptr));
        label_55->setText(QApplication::translate("ExportCloudsDialog", "Force visible by all vertices. Triangle visibility is based on the union of vertices visibility.", nullptr));
        comboBox_multiband_unwrap->setItemText(0, QApplication::translate("ExportCloudsDialog", "Basic", nullptr));
        comboBox_multiband_unwrap->setItemText(1, QApplication::translate("ExportCloudsDialog", "ABF", nullptr));
        comboBox_multiband_unwrap->setItemText(2, QApplication::translate("ExportCloudsDialog", "LSCM", nullptr));

        label_54->setText(QApplication::translate("ExportCloudsDialog", "Angle hard threshold. 0 to disable angle hard threshold filtering.", nullptr));
        label_53->setText(QApplication::translate("ExportCloudsDialog", "Best score threshold. 0 to disable filtering based on threshold to relative best score.", nullptr));
        checkBox_multiband_forcevisible->setText(QString());
        checkBox_multiband_fillholes->setText(QString());
        label_51->setText(QApplication::translate("ExportCloudsDialog", "Fill Texture holes with plausible values.", nullptr));
        label_56->setText(QApplication::translate("ExportCloudsDialog", "Number of contributions per frequency band for the multi-band blending. Should be 4 values.", nullptr));
        lineEdit_multiband_nbcontrib->setText(QApplication::translate("ExportCloudsDialog", "1 5 10 0", nullptr));
        groupBox_gp3->setTitle(QApplication::translate("ExportCloudsDialog", "Greedy Projection Triangulation (GP3) Meshing", nullptr));
        label_169->setText(QApplication::translate("ExportCloudsDialog", "Set the multiplier of the nearest neighbor distance to obtain the final search radius for each point  (this will make the algorithm adapt to different point densities in the cloud).", nullptr));
        doubleSpinBox_gp3Radius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
...
"Guidelines: 4 times the voxel size, 0.025 for voxel=0.", nullptr));
        groupBox_poisson->setTitle(QApplication::translate("ExportCloudsDialog", "Poisson Surface Reconstruction", nullptr));
        ...
        label_176->setText(QApplication::translate("ExportCloudsDialog", "Manifold flag. Enabling this flag tells the reconstructor to add the polygon barycenter when triangulating polygons with more than three vertices.", nullptr));
        label_181->setText(QApplication::translate("ExportCloudsDialog", "Point weight.", nullptr));
        label_182->setText(QApplication::translate("ExportCloudsDialog", "Min depth.", nullptr));
        ...
        label_180->setText(QApplication::translate("ExportCloudsDialog", "Scale. Set the ratio between the diameter of the cube used for reconstruction and the diameter of the samples' bounding cube.", nullptr));
        checkBox_poisson_outputPolygons->setText(QString());
        label_outputPolygons->setText(QApplication::translate("ExportCloudsDialog", "Output polygons flag. Enabling this flag tells the reconstructor to output a polygon mesh (rather than triangulating of the results of Marching Cubes). Disabled when exporting to file, if mesh decimation is set or when texturing.", nullptr));
        label_outputPolygons_2->setText(QApplication::translate("ExportCloudsDialog", "Target polygon size used to compute Poisson's depth based on the map size.", nullptr));
        doubleSpinBox_poisson_targetPolygonSize->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        groupBox_cputsdf->setTitle(QApplication::translate("ExportCloudsDialog", "CPU-TSDF Reconstruction", nullptr));
        label_25->setText(QApplication::translate("ExportCloudsDialog", "<html><head/><body><p><a href=\"https://github.com/sdmiller/cpu_tsdf\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/sdmiller/cpu_tsdf</span></a></p></body></html>", nullptr));
        doubleSpinBox_cputsdf_size->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_19->setText(QApplication::translate("ExportCloudsDialog", "Volume size.", nullptr));
        doubleSpinBox_cputsdf_resolution->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_20->setText(QApplication::translate("ExportCloudsDialog", "Resolution.", nullptr));
        doubleSpinBox_cputsdf_tuncPos->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_21->setText(QApplication::translate("ExportCloudsDialog", "Depth truncation positive limit. Maximum distance a voxel will be set to positive.", nullptr));
        doubleSpinBox_cputsdf_tuncNeg->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_22->setText(QApplication::translate("ExportCloudsDialog", "Depth truncation negative limit. Maximum distance a voxel will be set to negative.", nullptr));
        spinBox_cputsdf_randomSplit->setSuffix(QString());
        label_23->setText(QApplication::translate("ExportCloudsDialog", "Set the number of random samples per surface point the octree should split on. If you don't know what this does, it's almost certainly best to leave it at 1.", nullptr));
        doubleSpinBox_cputsdf_minWeight->setSuffix(QString());
        label_18->setText(QApplication::translate("ExportCloudsDialog", "Minimum weight of a voxel to be added in the mesh.", nullptr));
        doubleSpinBox_cputsdf_flattenRadius->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_24->setText(QApplication::translate("ExportCloudsDialog", "Flatten radius (0=disabled).", nullptr));
        groupBox_organized->setTitle(QApplication::translate("ExportCloudsDialog", "Organized Meshing", nullptr));
        label_15->setText(QApplication::translate("ExportCloudsDialog", "Triangle size", nullptr));
        label_quad->setText(QApplication::translate("ExportCloudsDialog", "Quad", nullptr));
        checkBox_mesh_quad->setText(QString());
        doubleSpinBox_mesh_angleTolerance->setSuffix(QApplication::translate("ExportCloudsDialog", " deg", nullptr));
        label_14->setText(QApplication::translate("ExportCloudsDialog", "Angle tolerance", nullptr));
        spinBox_mesh_triangleSize->setSuffix(QApplication::translate("ExportCloudsDialog", " pix", nullptr));
        groupBox_openchisel->setTitle(QApplication::translate("ExportCloudsDialog", "OpenChisel Reconstruction", nullptr));
        ...
        label_36->setText(QApplication::translate("ExportCloudsDialog", "truncation_constant", nullptr));
        label_35->setText(QApplication::translate("ExportCloudsDialog", "chunk_size_z", nullptr));
        label_40->setText(QApplication::translate("ExportCloudsDialog", "truncation_linear", nullptr));
        label_43->setText(QApplication::translate("ExportCloudsDialog", "integration_weight", nullptr));
        label_46->setText(QApplication::translate("ExportCloudsDialog", "near_plane_dist", nullptr));
        label_34->setText(QApplication::translate("ExportCloudsDialog", "chunk_size_y", nullptr));
        ...
        label_31->setText(QApplication::translate("ExportCloudsDialog", "chunk_size_x", nullptr));
        label_42->setText(QApplication::translate("ExportCloudsDialog", "truncation_scale", nullptr));
        label_41->setText(QApplication::translate("ExportCloudsDialog", "truncation_quadratic", nullptr));
        label_44->setText(QApplication::translate("ExportCloudsDialog", "use_voxel_carving", nullptr));
        label_45->setText(QApplication::translate("ExportCloudsDialog", "carving_dist_m", nullptr));
        label_47->setText(QApplication::translate("ExportCloudsDialog", "far_plane_dist", nullptr));
        ...
        doubleSpinBox_openchisel_carving_dist_m->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_openchisel_near_plane_dist->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        doubleSpinBox_openchisel_far_plane_dist->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_48->setText(QApplication::translate("ExportCloudsDialog", "Simplify generated mesh by merging close vertices together. Required for some post mesh filtering approaches to work properly.", nullptr));
