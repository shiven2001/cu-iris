...
public:
    ...
    void setupUi(QMainWindow *DatabaseViewer)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 419, 389));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 418, 389));
        ...
        page_4->setGeometry(QRect(0, 0, 276, 1201));
        ...
        page_5->setGeometry(QRect(0, 0, 294, 272));
        ...
        page_2->setGeometry(QRect(0, 0, 181, 485));
    ...
    {
        DatabaseViewer->setWindowTitle(QApplication::translate("DatabaseViewer", "Database viewer", nullptr));
        actionOpen_database->setText(QApplication::translate("DatabaseViewer", "Open database", nullptr));
        actionQuit->setText(QApplication::translate("DatabaseViewer", "Quit", nullptr));
        actionGenerate_graph_dot->setText(QApplication::translate("DatabaseViewer", "Generate graph (*.dot) ...", nullptr));
        actionGenerate_local_graph_dot->setText(QApplication::translate("DatabaseViewer", "Generate local graph (.dot) ...", nullptr));
        actionGenerate_3D_map_pcd->setText(QApplication::translate("DatabaseViewer", "Export 3D map (*.ply *.pcd) ...", nullptr));
        actionExport->setText(QApplication::translate("DatabaseViewer", "Export database...", nullptr));
        actionExtract_images->setText(QApplication::translate("DatabaseViewer", "Extract images...", nullptr));
        actionView_3D_map->setText(QApplication::translate("DatabaseViewer", "View 3D map...", nullptr));
        actionRefine_links->setText(QApplication::translate("DatabaseViewer", "Refine links...", nullptr));
#ifndef QT_NO_TOOLTIP
        actionRefine_links->setToolTip(QApplication::translate("DatabaseViewer", "Refine selected links with the registration strategy set in \"Core Parameters\"->\"Reg\", \"Vis\" and/or \"Icp\"", nullptr));
#endif // QT_NO_TOOLTIP
        actionDetect_more_loop_closures->setText(QApplication::translate("DatabaseViewer", "Detect more loop closures...", nullptr));
        actionSave_config->setText(QApplication::translate("DatabaseViewer", "Save config", nullptr));
        actionReset_all_changes->setText(QApplication::translate("DatabaseViewer", "Reset link and grid map changes", nullptr));
        actionRegenerate_local_grid_maps->setText(QApplication::translate("DatabaseViewer", "Regenerate local grid maps...", nullptr));
        actionRegenerate_local_grid_maps_selected->setText(QApplication::translate("DatabaseViewer", "Regenerate local grid maps (selected)...", nullptr));
        actionEdit_depth_image->setText(QApplication::translate("DatabaseViewer", "Edit depth image...", nullptr));
        actionVertical_Layout->setText(QApplication::translate("DatabaseViewer", "Vertical Layout", nullptr));
        actionConcise_Layout->setText(QApplication::translate("DatabaseViewer", "Concise Layout", nullptr));
        actionRestore_default_GUI_settings->setText(QApplication::translate("DatabaseViewer", "Restore default GUI settings", nullptr));
        actionRaw_format_txt->setText(QApplication::translate("DatabaseViewer", "Raw format (*.txt)", nullptr));
#ifndef QT_NO_TOOLTIP
        actionRaw_format_txt->setToolTip(QApplication::translate("DatabaseViewer", "Raw format (12 values transform)", nullptr));
#endif // QT_NO_TOOLTIP
        actionRGBD_SLAM_format_txt->setText(QApplication::translate("DatabaseViewer", "RGBD-SLAM format (*.txt)", nullptr));
#ifndef QT_NO_TOOLTIP
        actionRGBD_SLAM_format_txt->setToolTip(QApplication::translate("DatabaseViewer", "RGBD-SLAM (stamp tx ty tz qx qy qz qw)", nullptr));
#endif // QT_NO_TOOLTIP
        actionKITTI_format_txt->setText(QApplication::translate("DatabaseViewer", "KITTI format (*.txt)", nullptr));
#ifndef QT_NO_TOOLTIP
        actionKITTI_format_txt->setToolTip(QApplication::translate("DatabaseViewer", "KITTI (stamp + 12 values transform)", nullptr));
#endif // QT_NO_TOOLTIP
        actionTORO_graph->setText(QApplication::translate("DatabaseViewer", "TORO (*.graph)", nullptr));
        actionG2o_g2o->setText(QApplication::translate("DatabaseViewer", "g2o (*.g2o)", nullptr));
        actionGPS_KML->setText(QApplication::translate("DatabaseViewer", "Google Earth (*.kml)", nullptr));
        actionGPS_TXT->setText(QApplication::translate("DatabaseViewer", "Raw format (*.txt)", nullptr));
        actionPoses_KML->setText(QApplication::translate("DatabaseViewer", "Google Earth (*.kml)", nullptr));
        actionDatabase_recovery->setText(QApplication::translate("DatabaseViewer", "Database recovery", nullptr));
        actionClose_database->setText(QApplication::translate("DatabaseViewer", "Close database", nullptr));
        actionExport_saved_2D_map->setText(QApplication::translate("DatabaseViewer", "Export optimized 2D map...", nullptr));
        actionImport_2D_map->setText(QApplication::translate("DatabaseViewer", "Import optimized 2D map...", nullptr));
        actionView_optimized_mesh->setText(QApplication::translate("DatabaseViewer", "View optimized mesh", nullptr));
        actionExport_optimized_mesh->setText(QApplication::translate("DatabaseViewer", "Export optimized mesh...", nullptr));
        actionUpdate_optimized_mesh->setText(QApplication::translate("DatabaseViewer", "Update optimized mesh...", nullptr));
        actionUpdate_all_neighbor_covariances->setText(QApplication::translate("DatabaseViewer", "Update all neighbor covariances...", nullptr));
        actionUpdate_all_loop_closure_covariances->setText(QApplication::translate("DatabaseViewer", "Update all loop closure covariances...", nullptr));
        actionRGBD_SLAM_motion_capture_format_txt->setText(QApplication::translate("DatabaseViewer", "RGBD-SLAM motion capture format (*.txt)", nullptr));
#ifndef QT_NO_TOOLTIP
        actionRGBD_SLAM_motion_capture_format_txt->setToolTip(QApplication::translate("DatabaseViewer", "RGBD-SLAM (stamp tx ty tz qx qy qz qw)", nullptr));
#endif // QT_NO_TOOLTIP
        actionEdit_optimized_2D_map->setText(QApplication::translate("DatabaseViewer", "Edit optimized 2D map...", nullptr));
        actionRegenerate_optimized_2D_map->setText(QApplication::translate("DatabaseViewer", "Regenerate optimized 2D map...", nullptr));
        actionRGBD_SLAM_ID_format_txt->setText(QApplication::translate("DatabaseViewer", "RGBD-SLAM ID format (*.txt)", nullptr));
        actionUpdate_all_landmark_covariances->setText(QApplication::translate("DatabaseViewer", "Update all landmark covariances...", nullptr));
        label_childrenA_8->setText(QApplication::translate("DatabaseViewer", "Weight", nullptr));
        label_childrenA_24->setText(QApplication::translate("DatabaseViewer", "Gravity", nullptr));
        label_childrenA_2->setText(QApplication::translate("DatabaseViewer", "Children", nullptr));
        label_sensorsA->setText(QString());
        label_childrenA_6->setText(QApplication::translate("DatabaseViewer", "Stamp", nullptr));
        label_childrenA_22->setText(QApplication::translate("DatabaseViewer", "Scan", nullptr));
        label_childrenA_20->setText(QApplication::translate("DatabaseViewer", "Sensors", nullptr));
        label_scanA->setText(QString());
        label_childrenA_12->setText(QApplication::translate("DatabaseViewer", "Odometry Pose", nullptr));
        label_parentsA_2->setText(QApplication::translate("DatabaseViewer", "Parents", nullptr));
        label_weightA->setText(QString());
        label_gpsA->setText(QString());
        label_childrenA_14->setText(QApplication::translate("DatabaseViewer", "Calib", nullptr));
        label_childrenA_28->setText(QApplication::translate("DatabaseViewer", "Prior", nullptr));
        label_childrenA_18->setText(QApplication::translate("DatabaseViewer", "Velocity", nullptr));
        label_mapA->setText(QString());
        label_childrenA->setText(QString());
        label_childrenA_10->setText(QApplication::translate("DatabaseViewer", "Map ID", nullptr));
        label_childrenA_16->setText(QApplication::translate("DatabaseViewer", "GPS", nullptr));
        label_childrenA_27->setText(QApplication::translate("DatabaseViewer", "Ground Truth", nullptr));
        label_velA->setText(QString());
        label_childrenA_4->setText(QApplication::translate("DatabaseViewer", "Label", nullptr));
        ...
        label_childrenA_30->setText(QApplication::translate("DatabaseViewer", "Optimized Pose", nullptr));
        label_optposeA->setText(QString());
        label_priorA->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton_edit_priorA->setToolTip(QApplication::translate("DatabaseViewer", "Edit Constraint", nullptr));
#endif // QT_NO_TOOLTIP
        toolButton_edit_priorA->setText(QApplication::translate("DatabaseViewer", "...", nullptr));
#ifndef QT_NO_TOOLTIP
        toolButton_remove_priorA->setToolTip(QApplication::translate("DatabaseViewer", "Remove Prior", nullptr));
#endif // QT_NO_TOOLTIP
        toolButton_remove_priorA->setText(QApplication::translate("DatabaseViewer", "X", nullptr));
        label_childrenA_11->setText(QApplication::translate("DatabaseViewer", "Map ID", nullptr));
        label_poseB->setText(QString());
        label_childrenA_26->setText(QApplication::translate("DatabaseViewer", "Ground Truth", nullptr));
        label_childrenA_5->setText(QApplication::translate("DatabaseViewer", "Label", nullptr));
        label_childrenA_3->setText(QApplication::translate("DatabaseViewer", "Children", nullptr));
        label_childrenA_21->setText(QApplication::translate("DatabaseViewer", "Sensors", nullptr));
        label_childrenB->setText(QString());
        label_childrenA_7->setText(QApplication::translate("DatabaseViewer", "Stamp", nullptr));
        ...
        label_childrenA_13->setText(QApplication::translate("DatabaseViewer", "Odometry Pose", nullptr));
        label_childrenA_23->setText(QApplication::translate("DatabaseViewer", "Scan", nullptr));
        label_scanB->setText(QString());
        label_childrenA_15->setText(QApplication::translate("DatabaseViewer", "Calib", nullptr));
        label_childrenA_25->setText(QApplication::translate("DatabaseViewer", "Gravity", nullptr));
        label_parentsB->setText(QString());
        label_parentsA_4->setText(QApplication::translate("DatabaseViewer", "Parents", nullptr));
        label_stampB->setText(QString());
        label_childrenA_19->setText(QApplication::translate("DatabaseViewer", "Velocity", nullptr));
        label_sensorsB->setText(QString());
        label_calibB->setText(QString());
        label_childrenA_9->setText(QApplication::translate("DatabaseViewer", "Weight", nullptr));
        label_gtB->setText(QString());
        label_childrenA_17->setText(QApplication::translate("DatabaseViewer", "GPS", nullptr));
        label_weightB->setText(QString());
        label_childrenA_29->setText(QApplication::translate("DatabaseViewer", "Prior", nullptr));
        label_childrenA_31->setText(QApplication::translate("DatabaseViewer", "Optimized Pose", nullptr));
        label_optposeB->setText(QString());
        label_priorB->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton_edit_priorB->setToolTip(QApplication::translate("DatabaseViewer", "Edit Constraint", nullptr));
#endif // QT_NO_TOOLTIP
        toolButton_edit_priorB->setText(QApplication::translate("DatabaseViewer", "...", nullptr));
#ifndef QT_NO_TOOLTIP
        toolButton_remove_priorB->setToolTip(QApplication::translate("DatabaseViewer", "Remove Prior", nullptr));
#endif // QT_NO_TOOLTIP
        toolButton_remove_priorB->setText(QApplication::translate("DatabaseViewer", "X", nullptr));
        label_2->setText(QApplication::translate("DatabaseViewer", "Index :", nullptr));
        label_3->setText(QApplication::translate("DatabaseViewer", "Id :", nullptr));
        label_idA->setText(QApplication::translate("DatabaseViewer", "idA", nullptr));
        label_5->setText(QApplication::translate("DatabaseViewer", "Index :", nullptr));
        label_4->setText(QApplication::translate("DatabaseViewer", "Id :", nullptr));
        label_idB->setText(QApplication::translate("DatabaseViewer", "idB", nullptr));
        menuFile->setTitle(QApplication::translate("DatabaseViewer", "File", nullptr));
        menuExport_poses->setTitle(QApplication::translate("DatabaseViewer", "Export poses...", nullptr));
        menuExport_GPS->setTitle(QApplication::translate("DatabaseViewer", "Export GPS...", nullptr));
        menuEdit->setTitle(QApplication::translate("DatabaseViewer", "Edit", nullptr));
        menuView->setTitle(QApplication::translate("DatabaseViewer", "View", nullptr));
        dockWidget_constraints->setWindowTitle(QApplication::translate("DatabaseViewer", "Constraints view", nullptr));
        checkBox_show3DWords->setText(QApplication::translate("DatabaseViewer", "Words", nullptr));
        checkBox_show3Dclouds->setText(QApplication::translate("DatabaseViewer", "Clouds", nullptr));
        checkBox_show2DScans->setText(QApplication::translate("DatabaseViewer", "Scans", nullptr));
        checkBox_odomFrame->setText(QApplication::translate("DatabaseViewer", "Odom Frame", nullptr));
        label_variance->setText(QString());
        label->setText(QApplication::translate("DatabaseViewer", "Neighbor links", nullptr));
        label_6->setText(QApplication::translate("DatabaseViewer", "Loop closure links", nullptr));
        label_33->setText(QApplication::translate("DatabaseViewer", "Type", nullptr));
        checkBox_showOptimized->setText(QApplication::translate("DatabaseViewer", "Optimized", nullptr));
        label_constraint_opt->setText(QString());
        label_18->setText(QApplication::translate("DatabaseViewer", "\317\203 (lin, ang), cov", nullptr));
        label_type->setText(QString());
        label_type_name->setText(QString());
        label_constraint->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton_constraint->setToolTip(QApplication::translate("DatabaseViewer", "Edit Constraint", nullptr));
#endif // QT_NO_TOOLTIP
        toolButton_constraint->setText(QApplication::translate("DatabaseViewer", "...", nullptr));
        label_16->setText(QApplication::translate("DatabaseViewer", "Transform", nullptr));
#ifndef QT_NO_TOOLTIP
        pushButton_refine->setToolTip(QApplication::translate("DatabaseViewer", "Refine with the registration strategy set in \"Core Parameters\"->\"Reg\"", nullptr));
#endif // QT_NO_TOOLTIP
        pushButton_refine->setText(QApplication::translate("DatabaseViewer", "Refine", nullptr));
        pushButton_reset->setText(QApplication::translate("DatabaseViewer", "Reset", nullptr));
        pushButton_add->setText(QApplication::translate("DatabaseViewer", "Add", nullptr));
#ifndef QT_NO_TOOLTIP
        checkBox_enableForAll->setToolTip(QApplication::translate("DatabaseViewer", "Enable \"Add\" for all nodes (even not in graph)", nullptr));
#endif // QT_NO_TOOLTIP
        checkBox_enableForAll->setText(QString());
        pushButton_reject->setText(QApplication::translate("DatabaseViewer", "Reject", nullptr));
        dockWidget_graphView->setWindowTitle(QApplication::translate("DatabaseViewer", "Graph view", nullptr));
        label_rotation->setText(QApplication::translate("DatabaseViewer", "0.0 deg", nullptr));
#ifndef QT_NO_TOOLTIP
        pushButton_applyRotation->setToolTip(QApplication::translate("DatabaseViewer", "<html><head/><body><p>The rotation will be applied temporary to optimized global graph. To save it to database, do File-&gt;&quot;Regenerate optimized 2D map...&quot;.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        pushButton_applyRotation->setText(QApplication::translate("DatabaseViewer", "Apply Rotation", nullptr));
        label_iterations->setText(QApplication::translate("DatabaseViewer", "#", nullptr));
        comboBox_optimizationFlavor->setItemText(0, QApplication::translate("DatabaseViewer", "Global Iterative", nullptr));
        comboBox_optimizationFlavor->setItemText(1, QApplication::translate("DatabaseViewer", "Global Full", nullptr));
        comboBox_optimizationFlavor->setItemText(2, QApplication::translate("DatabaseViewer", "Local Optimized", nullptr));

        label_alignPosesWithGroundTruth->setText(QApplication::translate("DatabaseViewer", "Align poses with ground truth", nullptr));
        checkBox_ignoreIntermediateNodes->setText(QString());
        label_optimizeFrom->setText(QApplication::translate("DatabaseViewer", "Root", nullptr));
        checkBox_spanAllMaps->setText(QApplication::translate("DatabaseViewer", "Span to all maps", nullptr));
        checkBox_wmState->setText(QApplication::translate("DatabaseViewer", "WM", nullptr));
        label_45->setText(QApplication::translate("DatabaseViewer", "Time grid (s)", nullptr));
        label_rmse_title->setText(QApplication::translate("DatabaseViewer", "RMSE (m)", nullptr));
        ...
        label_alignScansCloudsWithGroundTruth->setText(QApplication::translate("DatabaseViewer", "Align scans/clouds with ground truth", nullptr));
        label_rmse->setText(QString());
        label_timeGrid->setText(QString());
#ifndef QT_NO_TOOLTIP
        label_41->setToolTip(QApplication::translate("DatabaseViewer", "<html><head/><body><p>N: Neighbor</p><p>NM: Neighbor Merged</p><p>G: Global</p><p>LS: Local by Space (Proximity)</p><p>LT: Local by Time (Proximity)</p><p>U: User</p><p>P: Prior</p><p>LM: Landmark</p><p>GR: Gravity</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_41->setText(QApplication::translate("DatabaseViewer", "Links (N, NM, G, LS, LT, U, P, LM, GR)", nullptr));
        label_10->setText(QApplication::translate("DatabaseViewer", "Path length (m)", nullptr));
        label_52->setText(QApplication::translate("DatabaseViewer", "Poses", nullptr));
        label_pathLength->setText(QString());
        label_loopClosures->setText(QString());
        label_ignoreINtermediateNdoes->setText(QApplication::translate("DatabaseViewer", "Ignore intermediate nodes", nullptr));
        label_39->setText(QApplication::translate("DatabaseViewer", "Time optimization (s)", nullptr));
        checkBox_alignPosesWithGroundTruth->setText(QString());
        label_alignPosesWithGPS->setText(QApplication::translate("DatabaseViewer", "Align poses with GPS", nullptr));
        checkBox_alignPosesWithGPS->setText(QString());
        dockWidget_guiparameters->setWindowTitle(QApplication::translate("DatabaseViewer", "GUI Parameters", nullptr));
        comboBox_logger_level->setItemText(0, QApplication::translate("DatabaseViewer", "Debug", nullptr));
        comboBox_logger_level->setItemText(1, QApplication::translate("DatabaseViewer", "Info", nullptr));
        comboBox_logger_level->setItemText(2, QApplication::translate("DatabaseViewer", "Warning", nullptr));
        comboBox_logger_level->setItemText(3, QApplication::translate("DatabaseViewer", "Error", nullptr));

        label_logger_level->setText(QApplication::translate("DatabaseViewer", "Logger level", nullptr));
        checkBox_ignoreGlobalLoop->setText(QString());
        label_49->setText(QApplication::translate("DatabaseViewer", "Ignore local loop closures (time)", nullptr));
        checkBox_ignoreLocalLoopSpace->setText(QString());
        label_48->setText(QApplication::translate("DatabaseViewer", "Ignore global loop closures", nullptr));
        label_35->setText(QApplication::translate("DatabaseViewer", "Ignore pose correction", nullptr));
        ...
        label_50->setText(QApplication::translate("DatabaseViewer", "Ignore user loop closures", nullptr));
        label_47->setText(QApplication::translate("DatabaseViewer", "Ignore local loop closures (space)", nullptr));
        label_scale_title->setText(QApplication::translate("DatabaseViewer", "Scale", nullptr));
        label_58->setText(QApplication::translate("DatabaseViewer", "Ignore landmarks", nullptr));
        checkBox_ignoreLandmarks->setText(QString());
        toolBox->setItemText(toolBox->indexOf(page_3), QApplication::translate("DatabaseViewer", "Graph optimization", nullptr));
        label_53->setText(QApplication::translate("DatabaseViewer", "OctoMap", nullptr));
        label_57->setText(QApplication::translate("DatabaseViewer", "Crop radius when filtering empty space from 2d occupancy grid.", nullptr));
        spinBox_cropRadius->setSuffix(QApplication::translate("DatabaseViewer", " pixels", nullptr));
        checkBox_grid_showProbMap->setText(QString());
        spinBox_decimation->setPrefix(QString());
        spinBox_grid_depth->setPrefix(QString());
        toolButton_groundColor->setText(QApplication::translate("DatabaseViewer", "...", nullptr));
        label_octomap_cubes->setText(QApplication::translate("DatabaseViewer", "OctoMap: Rendering type", nullptr));
        checkBox_grid_frontiers->setText(QString());
        label_54->setText(QApplication::translate("DatabaseViewer", "Voxel size (for clouds and scans)", nullptr));
        label_octomap_depth->setText(QApplication::translate("DatabaseViewer", "OctoMap: Tree depth", nullptr));
        checkBox_grid_regenerateFromSavedGrid->setText(QString());
        checkBox_octomap->setText(QString());
        label_octomap_empty_2->setText(QApplication::translate("DatabaseViewer", "Obstacle cell color", nullptr));
        label_51->setText(QApplication::translate("DatabaseViewer", "Gain compensation radius (Constraints view)", nullptr));
        checkBox_showDisparityInsteadOfRight->setText(QString());
        label_59->setText(QApplication::translate("DatabaseViewer", "Show probabilistic occupancy grid in Graph View.", nullptr));
        label_logger_level_2->setText(QApplication::translate("DatabaseViewer", "For stereo data, show disparity instead of right image in main views.", nullptr));
        label_octomap_empty_3->setText(QApplication::translate("DatabaseViewer", "Ground cell color", nullptr));
        doubleSpinBox_gainCompensationRadius->setSuffix(QApplication::translate("DatabaseViewer", " m", nullptr));
        label_octomap_empty_4->setText(QApplication::translate("DatabaseViewer", "Empty cell color", nullptr));
        toolButton_emptyColor->setText(QApplication::translate("DatabaseViewer", "...", nullptr));
        toolButton_obstacleColor->setText(QApplication::translate("DatabaseViewer", "...", nullptr));
        checkBox_cameraProjection->setText(QString());
        checkBox_grid_empty->setText(QString());
        label_55->setText(QApplication::translate("DatabaseViewer", "Local grid: regenerate from saved grid instead of sensors", nullptr));
        label_octomap_frontiers->setText(QApplication::translate("DatabaseViewer", "Show frontiers", nullptr));
        label_60->setText(QApplication::translate("DatabaseViewer", "Create RGB-D cloud from RGB projection on scan.", nullptr));
        label_octomap_empty->setText(QApplication::translate("DatabaseViewer", "Show empty space", nullptr));
        comboBox_octomap_rendering_type->setItemText(0, QApplication::translate("DatabaseViewer", "Point Cloud", nullptr));
        comboBox_octomap_rendering_type->setItemText(1, QApplication::translate("DatabaseViewer", "Cube", nullptr));
        comboBox_octomap_rendering_type->setItemText(2, QApplication::translate("DatabaseViewer", "Volume", nullptr));

        label_56->setText(QApplication::translate("DatabaseViewer", "Decimation (for images)", nullptr));
        doubleSpinBox_voxelSize->setSuffix(QApplication::translate("DatabaseViewer", " m", nullptr));
        label_octomap_frontiers_3->setText(QApplication::translate("DatabaseViewer", "Frontier cell color", nullptr));
        toolButton_frontierColor->setText(QApplication::translate("DatabaseViewer", "...", nullptr));
        groupBox_posefiltering->setTitle(QApplication::translate("DatabaseViewer", "Pose filtering", nullptr));
        doubleSpinBox_posefilteringAngle->setSuffix(QApplication::translate("DatabaseViewer", " degrees", nullptr));
        doubleSpinBox_posefilteringRadius->setSuffix(QApplication::translate("DatabaseViewer", " m", nullptr));
        label_42->setText(QApplication::translate("DatabaseViewer", "Radius", nullptr));
        label_43->setText(QApplication::translate("DatabaseViewer", "Angle", nullptr));
        groupBox->setTitle(QApplication::translate("DatabaseViewer", "Organized Fast Mesh", nullptr));
        label_14->setText(QApplication::translate("DatabaseViewer", "Triangle size", nullptr));
        label_12->setText(QApplication::translate("DatabaseViewer", "Angle tolerance", nullptr));
        spinBox_mesh_angleTolerance->setSuffix(QApplication::translate("DatabaseViewer", " deg", nullptr));
        spinBox_mesh_triangleSize->setSuffix(QApplication::translate("DatabaseViewer", " pix", nullptr));
        label_13->setText(QApplication::translate("DatabaseViewer", "Quad", nullptr));
        label_17->setText(QApplication::translate("DatabaseViewer", "Fill depth holes: error", nullptr));
        spinBox_mesh_depthError->setSuffix(QApplication::translate("DatabaseViewer", " %", nullptr));
        checkBox_mesh_quad->setText(QString());
        label_15->setText(QApplication::translate("DatabaseViewer", "Fill depth holes: size", nullptr));
        spinBox_mesh_fillDepthHoles->setSuffix(QApplication::translate("DatabaseViewer", " pix", nullptr));
        label_20->setText(QApplication::translate("DatabaseViewer", "Min cluster size", nullptr));
        spinBox_mesh_minClusterSize->setSuffix(QString());
        toolBox->setItemText(toolBox->indexOf(page_4), QApplication::translate("DatabaseViewer", "Grid/cloud generation", nullptr));
        doubleSpinBox_detectMore_radiusMin->setSuffix(QApplication::translate("DatabaseViewer", " m", nullptr));
        label_36->setText(QApplication::translate("DatabaseViewer", "Radius Min", nullptr));
        label_32->setText(QApplication::translate("DatabaseViewer", "Intra-session", nullptr));
        label_29->setText(QApplication::translate("DatabaseViewer", "Radius Max", nullptr));
        label_30->setText(QApplication::translate("DatabaseViewer", "Angle", nullptr));
        doubleSpinBox_detectMore_angle->setSuffix(QApplication::translate("DatabaseViewer", " degrees", nullptr));
        doubleSpinBox_detectMore_radius->setSuffix(QApplication::translate("DatabaseViewer", " m", nullptr));
        checkBox_detectMore_intraSession->setText(QString());
        label_31->setText(QApplication::translate("DatabaseViewer", "Iterations", nullptr));
        label_34->setText(QApplication::translate("DatabaseViewer", "Inter-session", nullptr));
        checkBox_detectMore_interSession->setText(QString());
        checkBox_opt_graph_as_guess->setText(QString());
        label_37->setText(QApplication::translate("DatabaseViewer", "Use optimized graph as guess", nullptr));
        toolBox->setItemText(toolBox->indexOf(page_5), QApplication::translate("DatabaseViewer", "Detect more loop closures", nullptr));
        label_9->setText(QApplication::translate("DatabaseViewer", "Decimation. Negative decimation is done from RGB size instead of depth size (if depth is smaller than RGB, it may be interpolated depending of the decimation value).", nullptr));
        label_11->setText(QApplication::translate("DatabaseViewer", "Max depth", nullptr));
        checkBox_icp_from_depth->setText(QString());
        label_7->setText(QApplication::translate("DatabaseViewer", "Generate laser scans from RGB-D images using the following parameters.", nullptr));
        label_19->setText(QApplication::translate("DatabaseViewer", "Min depth", nullptr));
        toolBox->setItemText(toolBox->indexOf(page_2), QApplication::translate("DatabaseViewer", "Refine", nullptr));
        dockWidget_stereoView->setWindowTitle(QApplication::translate("DatabaseViewer", "Stereo view", nullptr));
        label_stereo_inliers_name->setText(QApplication::translate("DatabaseViewer", "Inliers:", nullptr));
        label_stereo_inliers->setText(QApplication::translate("DatabaseViewer", "0", nullptr));
        label_stereo_slopeOutliers_name->setText(QApplication::translate("DatabaseViewer", "Slope outliers:", nullptr));
        label_stereo_slopeOutliers->setText(QApplication::translate("DatabaseViewer", "0", nullptr));
        label_stereo_disparityOutliers_name->setText(QApplication::translate("DatabaseViewer", "Negative disparity outliers:", nullptr));
        label_stereo_disparityOutliers->setText(QApplication::translate("DatabaseViewer", "0", nullptr));
        label_stereo_flowOutliers_name->setText(QApplication::translate("DatabaseViewer", "Flow outliers:", nullptr));
        label_stereo_flowOutliers->setText(QApplication::translate("DatabaseViewer", "0", nullptr));
        dockWidget_view3d->setWindowTitle(QApplication::translate("DatabaseViewer", "3D view", nullptr));
        checkBox_showWords->setText(QApplication::translate("DatabaseViewer", "Words", nullptr));
        checkBox_showCloud->setText(QApplication::translate("DatabaseViewer", "Cloud", nullptr));
        checkBox_showMesh->setText(QApplication::translate("DatabaseViewer", "Mesh", nullptr));
        checkBox_showScan->setText(QApplication::translate("DatabaseViewer", "Scan", nullptr));
        checkBox_showMap->setText(QApplication::translate("DatabaseViewer", "Map", nullptr));
        checkBox_showGrid->setText(QApplication::translate("DatabaseViewer", "Grid", nullptr));
#ifndef QT_NO_TOOLTIP
        checkBox_showElevation->setToolTip(QApplication::translate("DatabaseViewer", "Available if RTAB-Map is built with GridMap", nullptr));
#endif // QT_NO_TOOLTIP
        checkBox_showElevation->setText(QApplication::translate("DatabaseViewer", "Elevation", nullptr));
#ifndef QT_NO_TOOLTIP
        checkBox_odomFrame_3dview->setToolTip(QApplication::translate("DatabaseViewer", "Adjust roll, pitch and height based on odometry pose", nullptr));
#endif // QT_NO_TOOLTIP
        checkBox_odomFrame_3dview->setText(QApplication::translate("DatabaseViewer", "Odom", nullptr));
        checkBox_gravity_3dview->setText(QApplication::translate("DatabaseViewer", "Gravity", nullptr));
        dockWidget_info->setWindowTitle(QApplication::translate("DatabaseViewer", "Info", nullptr));
        dockWidget_coreparameters->setWindowTitle(QApplication::translate("DatabaseViewer", "Core Parameters", nullptr));
        dockWidget_statistics->setWindowTitle(QApplication::translate("DatabaseViewer", "Statistics", nullptr));
        checkBox_timeStats->setText(QString());
        label_logger_level_3->setText(QApplication::translate("DatabaseViewer", "Time (s) used in figures for x-axis instead of node IDs.", nullptr));
        dockWidget_occupancyGridView->setWindowTitle(QApplication::translate("DatabaseViewer", "Occupancy Grid", nullptr));
        checkBox_grid_grid->setText(QApplication::translate("DatabaseViewer", "Grid", nullptr));
        checkBox_grid_2d->setText(QApplication::translate("DatabaseViewer", "2d Map", nullptr));
#ifndef QT_NO_TOOLTIP
        checkBox_grid_elevation->setToolTip(QApplication::translate("DatabaseViewer", "Available if RTAB-Map is built with GridMap", nullptr));
#endif // QT_NO_TOOLTIP
        checkBox_grid_elevation->setText(QApplication::translate("DatabaseViewer", "Elevation", nullptr));
    } // retranslateUi
