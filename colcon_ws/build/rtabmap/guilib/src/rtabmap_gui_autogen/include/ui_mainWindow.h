...
public:
    ...
    void setupUi(QMainWindow *mainWindow)
    {
        ...
        mainWindow->addDockWidget(static_cast<Qt::DockWidgetArea>(2), dockWidget_multiSessionLoc);
    ...
    {
        mainWindow->setWindowTitle(QApplication::translate("mainWindow", "RTAB-Map : Real-Time Appearance-Based Mapping", nullptr));
...
#endif // QT_NO_TOOLTIP
        actionPause_on_match->setText(QApplication::translate("mainWindow", "Pause on loop closure detection", nullptr));
        actionStop->setText(QApplication::translate("mainWindow", "Stop", nullptr));
        actionDump_the_memory->setText(QApplication::translate("mainWindow", "Dump the memory", nullptr));
        actionPause_when_a_loop_hypothesis_is_rejected->setText(QApplication::translate("mainWindow", "Pause on loop closure rejection", nullptr));
        actionClear_cache->setText(QApplication::translate("mainWindow", "Clear the cache", nullptr));
        actionAuto_screen_capture->setText(QApplication::translate("mainWindow", "Auto screen capture...", nullptr));
        actionDump_the_prediction_matrix->setText(QApplication::translate("mainWindow", "Dump the prediction matrix", nullptr));
        actionGenerate_map->setText(QApplication::translate("mainWindow", "Generate graph (*.dot)...", nullptr));
        actionDelete_memory->setText(QApplication::translate("mainWindow", "Delete memory", nullptr));
        actionOpen_working_directory->setText(QApplication::translate("mainWindow", "Show working directory in file browser", nullptr));
        action16_9->setText(QApplication::translate("mainWindow", "16:9", nullptr));
        action16_10->setText(QApplication::translate("mainWindow", "16:10", nullptr));
        action4_3->setText(QApplication::translate("mainWindow", "4:3", nullptr));
        action360p->setText(QApplication::translate("mainWindow", "360p", nullptr));
        action480p->setText(QApplication::translate("mainWindow", "480p", nullptr));
        action720p->setText(QApplication::translate("mainWindow", "720p", nullptr));
        action1080p->setText(QApplication::translate("mainWindow", "1080p", nullptr));
        action240p->setText(QApplication::translate("mainWindow", "240p", nullptr));
        actionPrint_loop_closure_IDs_to_console->setText(QApplication::translate("mainWindow", "Print loop closure IDs to console", nullptr));
        actionSave_point_cloud->setText(QApplication::translate("mainWindow", "Export 3D clouds (*.ply *.pcd *.obj)...", nullptr));
        actionDownload_all_clouds->setText(QApplication::translate("mainWindow", "Download all clouds (update cache)", nullptr));
        actionPause_on_local_loop_detection->setText(QApplication::translate("mainWindow", "Pause on local loop closure detection", nullptr));
        actionSLAM_mode->setText(QApplication::translate("mainWindow", "Mapping", nullptr));
#ifndef QT_NO_TOOLTIP
        actionSLAM_mode->setToolTip(QApplication::translate("mainWindow", "Simultaneous Localization And Mapping (SLAM)", nullptr));
#endif // QT_NO_TOOLTIP
        actionLocalization_mode->setText(QApplication::translate("mainWindow", "Localization", nullptr));
        actionReset_Odometry->setText(QApplication::translate("mainWindow", "Reset Odometry", nullptr));
        actionView_high_res_point_cloud->setText(QApplication::translate("mainWindow", "View point clouds...", nullptr));
        actionTrigger_a_new_map->setText(QApplication::translate("mainWindow", "Trigger a new map", nullptr));
        actionDownload_graph->setText(QApplication::translate("mainWindow", "Download graph only", nullptr));
        actionScreenshot->setText(QApplication::translate("mainWindow", "Take a screenshot", nullptr));
        actionOpenNI_PCL->setText(QApplication::translate("mainWindow", "OpenNI-PCL", nullptr));
        actionFreenect->setText(QApplication::translate("mainWindow", "Freenect", nullptr));
        actionOpenNI_CV->setText(QApplication::translate("mainWindow", "OpenNI-CV", nullptr));
        actionOpenNI_CV_ASUS->setText(QApplication::translate("mainWindow", "OpenNI-CV-ASUS", nullptr));
        actionOpenNI2->setText(QApplication::translate("mainWindow", "OpenNI2", nullptr));
        actionOpenNI_PCL_ASUS->setText(QApplication::translate("mainWindow", "OpenNI-PCL", nullptr));
        actionData_recorder->setText(QApplication::translate("mainWindow", "Data recorder...", nullptr));
        actionExport_2D_Grid_map_bmp_png->setText(QApplication::translate("mainWindow", "Export 2D grid map (*.png *.bmp)...", nullptr));
        actionOpen_database->setText(QApplication::translate("mainWindow", "Open database...", nullptr));
        actionNew_database->setText(QApplication::translate("mainWindow", "New database...", nullptr));
        actionClose_database->setText(QApplication::translate("mainWindow", "Close database", nullptr));
        actionEdit_database->setText(QApplication::translate("mainWindow", "Edit database...", nullptr));
        actionPost_processing->setText(QApplication::translate("mainWindow", "Post-processing...", nullptr));
        actionSave_GUI_config->setText(QApplication::translate("mainWindow", "Save config", nullptr));
        actionFreenect2->setText(QApplication::translate("mainWindow", "Freenect2", nullptr));
        actionStereoDC1394->setText(QApplication::translate("mainWindow", "StereoDC1394", nullptr));
        actionOpenNI2_kinect->setText(QApplication::translate("mainWindow", "OpenNI2", nullptr));
        actionOpenNI2_sense->setText(QApplication::translate("mainWindow", "OpenNI2", nullptr));
        actionStereoFlyCapture2->setText(QApplication::translate("mainWindow", "FlyCapture2", nullptr));
        actionSend_goal->setText(QApplication::translate("mainWindow", "Send a goal...", nullptr));
        actionCancel_goal->setText(QApplication::translate("mainWindow", "Cancel goal", nullptr));
        actionDefault_views->setText(QApplication::translate("mainWindow", "Default views", nullptr));
        actionMore_options->setText(QApplication::translate("mainWindow", "More Options...", nullptr));
        actionLabel_current_location->setText(QApplication::translate("mainWindow", "Label current location...", nullptr));
        actionKITTI_format_txt->setText(QApplication::translate("mainWindow", "KITTI format (*.txt)", nullptr));
#ifndef QT_NO_TOOLTIP
        actionKITTI_format_txt->setToolTip(QApplication::translate("mainWindow", "KITTI (stamp + 12 values transform)", nullptr));
#endif // QT_NO_TOOLTIP
        actionRGBD_SLAM_format_txt->setText(QApplication::translate("mainWindow", "RGBD-SLAM format (*.txt)", nullptr));
#ifndef QT_NO_TOOLTIP
        actionRGBD_SLAM_format_txt->setToolTip(QApplication::translate("mainWindow", "RGBD-SLAM (stamp tx ty tz qx qy qz qw)", nullptr));
#endif // QT_NO_TOOLTIP
        actionTORO_graph->setText(QApplication::translate("mainWindow", "TORO (*.graph)", nullptr));
        actionExport_cameras_in_Bundle_format_out->setText(QApplication::translate("mainWindow", "Export cameras in Bundler format (*.out)...", nullptr));
        actionRaw_format_txt->setText(QApplication::translate("mainWindow", "Raw format (*.txt)", nullptr));
#ifndef QT_NO_TOOLTIP
        actionRaw_format_txt->setToolTip(QApplication::translate("mainWindow", "Raw format (12 values transform)", nullptr));
#endif // QT_NO_TOOLTIP
        actionG2o_g2o->setText(QApplication::translate("mainWindow", "g2o (*.g2o)", nullptr));
        actionCustom->setText(QApplication::translate("mainWindow", "Custom...", nullptr));
        actionSend_waypoints->setText(QApplication::translate("mainWindow", "Send waypoints...", nullptr));
        actionUpdate_cache_from_database->setText(QApplication::translate("mainWindow", "Update cache from a local database copy...", nullptr));
        actionExport_images_RGB_jpg_Depth_png->setText(QApplication::translate("mainWindow", "Export images (RGB=*.jpg Depth=*.png)...", nullptr));
        actionAnchor_clouds_to_ground_truth->setText(QApplication::translate("mainWindow", "Anchor clouds to ground truth", nullptr));
        actionStereoZed->setText(QApplication::translate("mainWindow", "Zed sdk", nullptr));
        actionStereoUsb->setText(QApplication::translate("mainWindow", "Stereo Usb Camera", nullptr));
        actionExport_octomap->setText(QApplication::translate("mainWindow", "Export octomap...", nullptr));
        actionRealSense_R200->setText(QApplication::translate("mainWindow", "RealSense", nullptr));
        actionDepth_Calibration->setText(QApplication::translate("mainWindow", "Depth calibration...", nullptr));
        actionRealSense_ZR300->setText(QApplication::translate("mainWindow", "RealSense", nullptr));
        actionKinect_for_Windows_SDK_v2->setText(QApplication::translate("mainWindow", "Kinect for Windows SDK v2", nullptr));
        actionKinect_for_Azure->setText(QApplication::translate("mainWindow", "Kinect for Azure", nullptr));
        actionRealSense2_D400->setText(QApplication::translate("mainWindow", "RealSense2", nullptr));
        actionStereoTara->setText(QApplication::translate("mainWindow", "Tara Stereo USB Camera", nullptr));
        actionRGBD_SLAM_motion_capture_format_txt->setText(QApplication::translate("mainWindow", "RGBD-SLAM motion capture format (*.txt)", nullptr));
#ifndef QT_NO_TOOLTIP
        actionRGBD_SLAM_motion_capture_format_txt->setToolTip(QApplication::translate("mainWindow", "RGBD-SLAM (stamp tx ty tz qx qy qz qw)", nullptr));
#endif // QT_NO_TOOLTIP
        actionRealSense2_T265->setText(QApplication::translate("mainWindow", "RealSense2", nullptr));
        actionRealSense2_SR300->setText(QApplication::translate("mainWindow", "RealSense2", nullptr));
        actionMYNT_EYE_S_SDK->setText(QApplication::translate("mainWindow", "MYNT EYE S SDK", nullptr));
        actionRealSense2_L515->setText(QApplication::translate("mainWindow", "RealSense2", nullptr));
        actionZed_Open_Capture->setText(QApplication::translate("mainWindow", "Zed Open Capture", nullptr));
        actionDepthAI_oakd->setText(QApplication::translate("mainWindow", "DepthAI", nullptr));
        actionRGBD_SLAM_ID_format_txt->setText(QApplication::translate("mainWindow", "RGBD-SLAM + ID format (*.txt)", nullptr));
        actionOpenNI2_orbbec->setText(QApplication::translate("mainWindow", "OpenNI2", nullptr));
        actionRemove_label->setText(QApplication::translate("mainWindow", "Remove label...", nullptr));
        actionDepthAI_oakdlite->setText(QApplication::translate("mainWindow", "Depth AI", nullptr));
        actionDepthAI_oakdpro->setText(QApplication::translate("mainWindow", "Depth AI", nullptr));
        actionVelodyne_VLP_16->setText(QApplication::translate("mainWindow", "Velodyne VLP-16", nullptr));
        actionXvisio_SeerSense->setText(QApplication::translate("mainWindow", "Xvisio", nullptr));
        menuFile->setTitle(QApplication::translate("mainWindow", "File", nullptr));
        menuExport_poses->setTitle(QApplication::translate("mainWindow", "Export poses...", nullptr));
        menuEdit->setTitle(QApplication::translate("mainWindow", " Edit", nullptr));
        menuAdvanced->setTitle(QApplication::translate("mainWindow", "Advanced", nullptr));
        menu6->setTitle(QApplication::translate("mainWindow", "?", nullptr));
        menuProcess->setTitle(QApplication::translate("mainWindow", "Detection", nullptr));
        menuSelect_source->setTitle(QApplication::translate("mainWindow", "Select source", nullptr));
        menuRGB_D_camera->setTitle(QApplication::translate("mainWindow", "RGB-D camera", nullptr));
        menuKinect_for_Xbox_360->setTitle(QApplication::translate("mainWindow", "Kinect", nullptr));
        menuXtion_PRO_LIVE->setTitle(QApplication::translate("mainWindow", "Xtion PRO LIVE", nullptr));
        menuSense_3D_scanner->setTitle(QApplication::translate("mainWindow", "Sense 3D scanner", nullptr));
        menuKinect_v2->setTitle(QApplication::translate("mainWindow", "Kinect v2", nullptr));
        menuKinect_K4A->setTitle(QApplication::translate("mainWindow", "Kinect for Azure", nullptr));
        menuRealSense_R200->setTitle(QApplication::translate("mainWindow", "RealSense R200", nullptr));
        menuRealSense_ZR300->setTitle(QApplication::translate("mainWindow", "RealSense ZR300", nullptr));
        menuRealSense_D435->setTitle(QApplication::translate("mainWindow", "RealSense D400", nullptr));
        menuRealSense_SR300->setTitle(QApplication::translate("mainWindow", "RealSense SR300", nullptr));
        menuRealSense_L515->setTitle(QApplication::translate("mainWindow", "RealSense L515", nullptr));
        menuOrbbec_Astra->setTitle(QApplication::translate("mainWindow", "Orbbec Astra", nullptr));
        menuXvisio_SeerSense->setTitle(QApplication::translate("mainWindow", "Xvisio SeerSense", nullptr));
        menuStereo_camera->setTitle(QApplication::translate("mainWindow", "Stereo camera", nullptr));
        menuBumblebee2_2->setTitle(QApplication::translate("mainWindow", "Bumblebee2", nullptr));
        menuZed_camera->setTitle(QApplication::translate("mainWindow", "Zed camera", nullptr));
        menuTara_Camera->setTitle(QApplication::translate("mainWindow", "Tara Camera", nullptr));
        menuRealSense_T265->setTitle(QApplication::translate("mainWindow", "RealSense T265", nullptr));
        menuMynt_Eye_S->setTitle(QApplication::translate("mainWindow", "Mynt Eye S", nullptr));
        menuOAK_D->setTitle(QApplication::translate("mainWindow", "OAK-D", nullptr));
        menuOAK_D_Lite->setTitle(QApplication::translate("mainWindow", "OAK-D Lite", nullptr));
        menuOAK_D_Pro->setTitle(QApplication::translate("mainWindow", "OAK-D Pro", nullptr));
        menuLiDAR->setTitle(QApplication::translate("mainWindow", "LiDAR", nullptr));
        menuWindow->setTitle(QApplication::translate("mainWindow", "Window", nullptr));
        menuShow_view->setTitle(QApplication::translate("mainWindow", "Show view", nullptr));
        menuAspect_ratio_2->setTitle(QApplication::translate("mainWindow", "Aspect ratio", nullptr));
        menuTools->setTitle(QApplication::translate("mainWindow", "Tools", nullptr));
        dockWidget_posterior->setWindowTitle(QApplication::translate("mainWindow", "A posteriori PDF", nullptr));
        toolBar->setWindowTitle(QApplication::translate("mainWindow", "toolBar", nullptr));
        dockWidget_statsV2->setWindowTitle(QApplication::translate("mainWindow", "Statistics", nullptr));
        doubleSpinBox_stats_timeLimit->setSuffix(QApplication::translate("mainWindow", " ms", nullptr));
        label_source->setText(QApplication::translate("mainWindow", "Source", nullptr));
        label_stats_source->setText(QApplication::translate("mainWindow", "Unknown", nullptr));
        doubleSpinBox_stats_imgRate->setSuffix(QApplication::translate("mainWindow", " Hz", nullptr));
        label_45->setText(QApplication::translate("mainWindow", "Elapsed time (hh:mm:ss)", nullptr));
        label_elapsedTime->setText(QApplication::translate("mainWindow", "Unknown", nullptr));
        label_20->setText(QApplication::translate("mainWindow", "Current image id [Map id]", nullptr));
        label_stats_imageNumber->setText(QApplication::translate("mainWindow", "Unknown", nullptr));
        label_12->setText(QApplication::translate("mainWindow", "Loop closures detected", nullptr));
        label_stats_loopClosuresDetected->setText(QApplication::translate("mainWindow", "0", nullptr));
        label_38->setText(QApplication::translate("mainWindow", "Loop closures detected \n"
"(only reactivated ones)", nullptr));
        label_stats_loopClosuresReactivatedDetected->setText(QApplication::translate("mainWindow", "0", nullptr));
        label_15->setText(QApplication::translate("mainWindow", "Loop closures rejected", nullptr));
        label_stats_loopClosuresRejected->setText(QApplication::translate("mainWindow", "0", nullptr));
        doubleSpinBox_stats_imgRate_label->setText(QApplication::translate("mainWindow", "Image rate", nullptr));
        label_timeLimit->setText(QApplication::translate("mainWindow", "Time limit processing", nullptr));
        doubleSpinBox_stats_detectionRate->setSuffix(QApplication::translate("mainWindow", " Hz", nullptr));
        doubleSpinBox_stats_imgRate_label_2->setText(QApplication::translate("mainWindow", "RTAB-Map update rate", nullptr));
        dockWidget_likelihood->setWindowTitle(QApplication::translate("mainWindow", "Likelihood", nullptr));
        dockWidget_console->setWindowTitle(QApplication::translate("mainWindow", "Console", nullptr));
        dockWidget_rawlikelihood->setWindowTitle(QApplication::translate("mainWindow", "Raw Likelihood", nullptr));
        dockWidget_cloudViewer->setWindowTitle(QApplication::translate("mainWindow", "3D Map", nullptr));
        dockWidget_loopClosureViewer->setWindowTitle(QApplication::translate("mainWindow", "3D Loop closure", nullptr));
        dockWidget_mapVisibility->setWindowTitle(QApplication::translate("mainWindow", "Map visibility", nullptr));
        dockWidget_graphViewer->setWindowTitle(QApplication::translate("mainWindow", "Graph view", nullptr));
        dockWidget_imageView->setWindowTitle(QApplication::translate("mainWindow", "Loop closure detection", nullptr));
        label_refId->setText(QString());
        label_matchId->setText(QString());
        dockWidget_odometry->setWindowTitle(QApplication::translate("mainWindow", "Odometry", nullptr));
        toolBar_2->setWindowTitle(QApplication::translate("mainWindow", "toolBar_2", nullptr));
        dockWidget_multiSessionLoc->setWindowTitle(QApplication::translate("mainWindow", "Multi-Session Localization", nullptr));
    } // retranslateUi
