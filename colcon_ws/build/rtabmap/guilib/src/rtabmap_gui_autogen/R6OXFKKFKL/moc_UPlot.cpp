...
QT_MOC_LITERAL(24, 235, 7) // "setData"
    ...
    "QVector<UPlotItem*>&\0QVector<qreal>\0"
    "xs\0ys\0QVector<int>\0std::vector<qreal>\0"
    "std::vector<int>\0setData"
};
...
static const uint qt_meta_data_UPlotCurve[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, QMetaType::QReal, QMetaType::QReal,   15,   14,
    ...
    QMetaType::Void, 0x80000000 | 18, 0x80000000 | 18,   15,   14,
    QMetaType::Void, 0x80000000 | 22, 0x80000000 | 22,   15,   14,
...
void UPlotCurve::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->setXIncrement((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 4: _t->setXStart((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 5: _t->addValue((*reinterpret_cast< UPlotItem*(*)>(_a[1]))); break;
        case 6: _t->addValue((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 7: _t->addValue((*reinterpret_cast< qreal(*)>(_a[1])),(*reinterpret_cast< qreal(*)>(_a[2]))); break;
        ...
        case 10: _t->addValues((*reinterpret_cast< const QVector<qreal>(*)>(_a[1])),(*reinterpret_cast< const QVector<qreal>(*)>(_a[2]))); break;
        case 11: _t->addValues((*reinterpret_cast< const QVector<qreal>(*)>(_a[1]))); break;
        case 12: _t->addValues((*reinterpret_cast< const QVector<int>(*)>(_a[1]))); break;
        case 13: _t->addValues((*reinterpret_cast< const std::vector<qreal>(*)>(_a[1]))); break;
        case 14: _t->addValues((*reinterpret_cast< const std::vector<int>(*)>(_a[1]))); break;
        case 15: _t->setData((*reinterpret_cast< const QVector<qreal>(*)>(_a[1])),(*reinterpret_cast< const QVector<qreal>(*)>(_a[2]))); break;
        case 16: _t->setData((*reinterpret_cast< const std::vector<qreal>(*)>(_a[1])),(*reinterpret_cast< const std::vector<qreal>(*)>(_a[2]))); break;
        case 17: _t->setData((*reinterpret_cast< const QVector<qreal>(*)>(_a[1]))); break;
        case 18: _t->setData((*reinterpret_cast< const std::vector<qreal>(*)>(_a[1]))); break;
        default: ;
        }
...
void UPlotCurveThreshold::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setThreshold((*reinterpret_cast< qreal(*)>(_a[1]))); break;
...
QT_MOC_LITERAL(4, 53, 13), // "moveUpRequest"
QT_MOC_LITERAL(5, 67, 16), // "UPlotLegendItem*"
QT_MOC_LITERAL(6, 84, 15), // "moveDownRequest"
QT_MOC_LITERAL(7, 100, 19) // "updateStdDevMeanMax"

    },
    "UPlotLegendItem\0legendItemRemoved\0\0"
    "const UPlotCurve*\0moveUpRequest\0"
    "UPlotLegendItem*\0moveDownRequest\0"
    "updateStdDevMeanMax"
};
#undef QT_MOC_LITERAL
...
void UPlotLegendItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->moveUpRequest((*reinterpret_cast< UPlotLegendItem*(*)>(_a[1]))); break;
        case 2: _t->moveDownRequest((*reinterpret_cast< UPlotLegendItem*(*)>(_a[1]))); break;
        case 3: _t->updateStdDevMeanMax(); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
        ...
        case 1:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< UPlotLegendItem* >(); break;
            }
            break;
        case 2:
            switch (*reinterpret_cast<int*>(_a[1])) {
        ...
        {
            using _t = void (UPlotLegendItem::*)(UPlotLegendItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UPlotLegendItem::moveUpRequest)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (UPlotLegendItem::*)(UPlotLegendItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UPlotLegendItem::moveDownRequest)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void UPlotLegendItem::moveUpRequest(UPlotLegendItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void UPlotLegendItem::moveDownRequest(UPlotLegendItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
QT_MOC_LITERAL(7, 81, 15), // "legendItemMoved"
QT_MOC_LITERAL(8, 97, 16), // "removeLegendItem"
QT_MOC_LITERAL(9, 114, 6), // "moveUp"
QT_MOC_LITERAL(10, 121, 16), // "UPlotLegendItem*"
QT_MOC_LITERAL(11, 138, 4), // "item"
QT_MOC_LITERAL(12, 143, 8), // "moveDown"
QT_MOC_LITERAL(13, 152, 15) // "redirectToggled"

    },
    "UPlotLegend\0legendItemRemoved\0\0"
    "const UPlotCurve*\0curve\0legendItemToggled\0"
    "toggled\0legendItemMoved\0removeLegendItem\0"
    "moveUp\0UPlotLegendItem*\0item\0moveDown\0"
    "redirectToggled"
};
#undef QT_MOC_LITERAL
...
void UPlotLegend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->legendItemMoved((*reinterpret_cast< const UPlotCurve*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->removeLegendItem((*reinterpret_cast< const UPlotCurve*(*)>(_a[1]))); break;
        case 4: _t->moveUp((*reinterpret_cast< UPlotLegendItem*(*)>(_a[1]))); break;
        case 5: _t->moveDown((*reinterpret_cast< UPlotLegendItem*(*)>(_a[1]))); break;
        case 6: _t->redirectToggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
        ...
        {
            using _t = void (UPlotLegend::*)(const UPlotCurve * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UPlotLegend::legendItemMoved)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void UPlotLegend::legendItemMoved(const UPlotCurve * _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
    QMetaObject::activate(this, &staticMetaObject, 2, _a);
}
...
QT_MOC_LITERAL(9, 80, 9), // "frameData"
QT_MOC_LITERAL(10, 90, 5), // "xAxis"
QT_MOC_LITERAL(11, 96, 5), // "yAxis"
QT_MOC_LITERAL(12, 102, 13), // "captureScreen"
QT_MOC_LITERAL(13, 116, 9), // "moveCurve"
QT_MOC_LITERAL(14, 126, 5) // "index"

    },
    "UPlot\0removeCurve\0\0const UPlotCurve*\0"
    "curve\0showCurve\0shown\0updateAxis\0"
    "clearData\0frameData\0xAxis\0yAxis\0"
    "captureScreen\0moveCurve\0index"
};
#undef QT_MOC_LITERAL
...
static const uint qt_meta_data_UPlot[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       9,    1,   79,    2, 0x2a /* Public | MethodCloned */,
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 3,    4,
    QMetaType::Void, 0x80000000 | 3, QMetaType::Int,    2,   14,
...
void UPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->frameData((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 5: _t->frameData((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->frameData(); break;
        case 7: _t->captureScreen(); break;
        case 8: _t->updateAxis((*reinterpret_cast< const UPlotCurve*(*)>(_a[1]))); break;
        case 9: _t->moveCurve((*reinterpret_cast< const UPlotCurve*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
