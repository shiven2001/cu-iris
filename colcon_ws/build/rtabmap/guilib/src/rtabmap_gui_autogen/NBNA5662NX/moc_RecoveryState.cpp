...
void rtabmap::RecoveryState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RecoveryState *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rtabmap::RecoveryState::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_rtabmap__RecoveryState.data,
    qt_meta_data_rtabmap__RecoveryState,
    qt_static_metacall,
    nullptr,
    nullptr
} };
