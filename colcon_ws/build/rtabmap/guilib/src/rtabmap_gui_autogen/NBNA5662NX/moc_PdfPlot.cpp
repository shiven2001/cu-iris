...
QT_INIT_METAOBJECT const QMetaObject rtabmap::PdfPlotCurve::staticMetaObject = { {
    &UPlotCurve::staticMetaObject,
    qt_meta_stringdata_rtabmap__PdfPlotCurve.data,
    qt_meta_data_rtabmap__PdfPlotCurve,
    qt_static_metacall,
    nullptr,
    nullptr
} };
