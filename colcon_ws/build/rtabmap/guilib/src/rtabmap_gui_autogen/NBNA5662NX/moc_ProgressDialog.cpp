...
struct qt_meta_stringdata_rtabmap__ProgressDialog_t {
    QByteArrayData data[12];
    char stringdata0[115];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rtabmap__ProgressDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rtabmap__ProgressDialog_t qt_meta_stringdata_rtabmap__ProgressDialog = {
    {
QT_MOC_LITERAL(0, 0, 23), // "rtabmap::ProgressDialog"
QT_MOC_LITERAL(1, 24, 8), // "canceled"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 10), // "appendText"
QT_MOC_LITERAL(4, 45, 4), // "text"
QT_MOC_LITERAL(5, 50, 5), // "color"
QT_MOC_LITERAL(6, 56, 13), // "incrementStep"
QT_MOC_LITERAL(7, 70, 5), // "steps"
QT_MOC_LITERAL(8, 76, 5), // "clear"
QT_MOC_LITERAL(9, 82, 13), // "resetProgress"
QT_MOC_LITERAL(10, 96, 11), // "closeDialog"
QT_MOC_LITERAL(11, 108, 6) // "cancel"

    },
    "rtabmap::ProgressDialog\0canceled\0\0"
    "appendText\0text\0color\0incrementStep\0"
    "steps\0clear\0resetProgress\0closeDialog\0"
    "cancel"
};
...
void rtabmap::ProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProgressDialog::canceled)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject rtabmap::ProgressDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_rtabmap__ProgressDialog.data,
    qt_meta_data_rtabmap__ProgressDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *rtabmap::ProgressDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rtabmap__ProgressDialog.stringdata0))
