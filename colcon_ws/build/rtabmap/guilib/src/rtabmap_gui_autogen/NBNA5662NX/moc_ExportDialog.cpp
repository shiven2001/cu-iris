...
void rtabmap::ExportDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ExportDialog::configChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject rtabmap::ExportDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_rtabmap__ExportDialog.data,
    qt_meta_data_rtabmap__ExportDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
