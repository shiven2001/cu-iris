...
void rtabmap::MapVisibilityWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MapVisibilityWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MapVisibilityWidget::*)(int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapVisibilityWidget::visibilityChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject rtabmap::MapVisibilityWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_rtabmap__MapVisibilityWidget.data,
    qt_meta_data_rtabmap__MapVisibilityWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
