...
void rtabmap::EditDepthArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EditDepthArea *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rtabmap::EditDepthArea::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_rtabmap__EditDepthArea.data,
    qt_meta_data_rtabmap__EditDepthArea,
    qt_static_metacall,
    nullptr,
    nullptr
} };
