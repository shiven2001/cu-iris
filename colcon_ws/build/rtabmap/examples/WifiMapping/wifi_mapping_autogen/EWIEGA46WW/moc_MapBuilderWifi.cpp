...
void MapBuilderWifi::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MapBuilderWifi *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MapBuilderWifi::staticMetaObject = { {
    &MapBuilder::staticMetaObject,
    qt_meta_stringdata_MapBuilderWifi.data,
    qt_meta_data_MapBuilderWifi,
    qt_static_metacall,
    nullptr,
    nullptr
} };
