...
struct CameraModels_
{
  ...
  using _models_type =
    std::vector<rtabmap_msgs::msg::CameraModel_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::CameraModel_<ContainerAllocator>>::other>;
  _models_type models;

  // setters for named parameter idiom
  Type & set__models(
    const std::vector<rtabmap_msgs::msg::CameraModel_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::CameraModel_<ContainerAllocator>>::other> & _arg)
  {
    this->models = _arg;
    return *this;
  }
