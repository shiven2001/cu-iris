...
struct OdomInfo_
{
  ...
  using _local_bundle_models_type =
    std::vector<rtabmap_msgs::msg::CameraModels_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::CameraModels_<ContainerAllocator>>::other>;
  ...
  using _ref_corners_type =
    std::vector<rtabmap_msgs::msg::Point2f_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::Point2f_<ContainerAllocator>>::other>;
  ...
  Type & set__local_bundle_models(
    const std::vector<rtabmap_msgs::msg::CameraModels_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::CameraModels_<ContainerAllocator>>::other> & _arg)
  {
  ...
  Type & set__ref_corners(
    const std::vector<rtabmap_msgs::msg::Point2f_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::Point2f_<ContainerAllocator>>::other> & _arg)
  {
