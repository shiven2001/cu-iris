...
struct RGBDImages_
{
  ...
  using _rgbd_images_type =
    std::vector<rtabmap_msgs::msg::RGBDImage_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::RGBDImage_<ContainerAllocator>>::other>;
  ...
  Type & set__rgbd_images(
    const std::vector<rtabmap_msgs::msg::RGBDImage_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::RGBDImage_<ContainerAllocator>>::other> & _arg)
  {
