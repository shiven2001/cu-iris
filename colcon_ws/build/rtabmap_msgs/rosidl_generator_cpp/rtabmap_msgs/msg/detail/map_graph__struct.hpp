...
struct MapGraph_
{
  ...
  _poses_type poses;
  using _links_type =
    std::vector<rtabmap_msgs::msg::Link_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::Link_<ContainerAllocator>>::other>;
  _links_type links;
  ...
  Type & set__links(
    const std::vector<rtabmap_msgs::msg::Link_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::Link_<ContainerAllocator>>::other> & _arg)
  {
    this->links = _arg;
    return *this;
  }
