...
struct MapData_
{
  ...
  _graph_type graph;
  using _nodes_type =
    std::vector<rtabmap_msgs::msg::Node_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::Node_<ContainerAllocator>>::other>;
  _nodes_type nodes;
  ...
  Type & set__nodes(
    const std::vector<rtabmap_msgs::msg::Node_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_msgs::msg::Node_<ContainerAllocator>>::other> & _arg)
  {
    this->nodes = _arg;
    return *this;
  }
