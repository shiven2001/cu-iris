...
{
  new (message_memory) rtabmap_msgs::msg::MapGraph(_init);
}

void MapGraph_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::msg::MapGraph *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<rtabmap_msgs::msg::Link> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rtabmap_msgs::msg::Link> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rtabmap_msgs::msg::Link> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MapGraph_message_member_array[5] = {
  {
    ...
    offsetof(rtabmap_msgs::msg::MapGraph, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::MapGraph, map_to_odom),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::MapGraph, poses_id),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::MapGraph, poses),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::MapGraph, links),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MapGraph_message_members = {
  ...
  5,  // number of fields
  sizeof(rtabmap_msgs::msg::MapGraph),
...
get_message_type_support_handle<rtabmap_msgs::msg::MapGraph>()
{
  return &::rtabmap_msgs::msg::rosidl_typesupport_introspection_cpp::MapGraph_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, msg, MapGraph)() {
  return &::rtabmap_msgs::msg::rosidl_typesupport_introspection_cpp::MapGraph_message_type_support_handle;
}
