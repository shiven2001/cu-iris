...
{
  new (message_memory) rtabmap_msgs::msg::Path(_init);
}

void Path_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::msg::Path *>(message_memory);
  typed_message->~Path();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Path_message_member_array[3] = {
  {
    ...
    offsetof(rtabmap_msgs::msg::Path, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::Path, node_ids),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::Path, poses),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<rtabmap_msgs::msg::Path>()
{
  return &::rtabmap_msgs::msg::rosidl_typesupport_introspection_cpp::Path_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, msg, Path)() {
  return &::rtabmap_msgs::msg::rosidl_typesupport_introspection_cpp::Path_message_type_support_handle;
}
