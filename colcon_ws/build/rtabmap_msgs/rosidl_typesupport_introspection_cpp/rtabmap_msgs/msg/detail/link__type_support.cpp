...
{
  new (message_memory) rtabmap_msgs::msg::Link(_init);
}

void Link_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::msg::Link *>(message_memory);
  typed_message->~Link();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Link_message_member_array[5] = {
  {
    ...
    offsetof(rtabmap_msgs::msg::Link, from_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::Link, to_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::Link, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::Link, transform),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    36,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::msg::Link, information),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<rtabmap_msgs::msg::Link>()
{
  return &::rtabmap_msgs::msg::rosidl_typesupport_introspection_cpp::Link_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, msg, Link)() {
  return &::rtabmap_msgs::msg::rosidl_typesupport_introspection_cpp::Link_message_type_support_handle;
}
