...
{
  new (message_memory) rtabmap_msgs::srv::GetMap_Request(_init);
}

void GetMap_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::srv::GetMap_Request *>(message_memory);
  typed_message->~GetMap_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GetMap_Request_message_member_array[3] = {
  {
    "global_map",  // name
    ...
    offsetof(rtabmap_msgs::srv::GetMap_Request, global_map),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::srv::GetMap_Request, optimized),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::srv::GetMap_Request, graph_only),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetMap_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(rtabmap_msgs::srv::GetMap_Request),
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, GetMap_Request)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetMap_Request_message_type_support_handle;
}
...
void GetMap_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rtabmap_msgs::srv::GetMap_Response(_init);
}

void GetMap_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::srv::GetMap_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetMap_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::srv::GetMap_Response, data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetMap_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rtabmap_msgs::srv::GetMap_Response),
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, GetMap_Response)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetMap_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetMap_service_members = {
  ...
  // see get_service_type_support_handle<rtabmap_msgs::srv::GetMap>()
...
get_service_type_support_handle<rtabmap_msgs::srv::GetMap>()
{
  ...
  auto service_type_support =
    &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetMap_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, GetMap)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rtabmap_msgs::srv::GetMap>();
}
