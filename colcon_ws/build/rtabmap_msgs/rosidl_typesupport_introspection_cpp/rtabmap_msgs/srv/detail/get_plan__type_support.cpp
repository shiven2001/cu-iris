...
{
  new (message_memory) rtabmap_msgs::srv::GetPlan_Request(_init);
}

void GetPlan_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::srv::GetPlan_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetPlan_Request_message_member_array[3] = {
  {
    ...
    offsetof(rtabmap_msgs::srv::GetPlan_Request, goal_node),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::srv::GetPlan_Request, goal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::srv::GetPlan_Request, tolerance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetPlan_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(rtabmap_msgs::srv::GetPlan_Request),
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetPlan_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, GetPlan_Request)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetPlan_Request_message_type_support_handle;
}
...
void GetPlan_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rtabmap_msgs::srv::GetPlan_Response(_init);
}

void GetPlan_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::srv::GetPlan_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetPlan_Response_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rtabmap_msgs::msg::Path>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::srv::GetPlan_Response, plan),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetPlan_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rtabmap_msgs::srv::GetPlan_Response),
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetPlan_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, GetPlan_Response)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetPlan_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetPlan_service_members = {
  ...
  // see get_service_type_support_handle<rtabmap_msgs::srv::GetPlan>()
...
get_service_type_support_handle<rtabmap_msgs::srv::GetPlan>()
{
  ...
  auto service_type_support =
    &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::GetPlan_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, GetPlan)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rtabmap_msgs::srv::GetPlan>();
}
