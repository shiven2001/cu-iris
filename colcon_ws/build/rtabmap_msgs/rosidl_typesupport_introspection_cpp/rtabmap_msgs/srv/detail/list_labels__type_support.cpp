...
{
  new (message_memory) rtabmap_msgs::srv::ListLabels_Request(_init);
}

void ListLabels_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::srv::ListLabels_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ListLabels_Request_message_member_array[1] = {
  {
    ...
    offsetof(rtabmap_msgs::srv::ListLabels_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ListLabels_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(rtabmap_msgs::srv::ListLabels_Request),
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::ListLabels_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, ListLabels_Request)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::ListLabels_Request_message_type_support_handle;
}
...
void ListLabels_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rtabmap_msgs::srv::ListLabels_Response(_init);
}

void ListLabels_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_msgs::srv::ListLabels_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ListLabels_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::srv::ListLabels_Response, ids),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs::srv::ListLabels_Response, labels),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ListLabels_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(rtabmap_msgs::srv::ListLabels_Response),
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::ListLabels_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, ListLabels_Response)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::ListLabels_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers ListLabels_service_members = {
  ...
  // see get_service_type_support_handle<rtabmap_msgs::srv::ListLabels>()
...
get_service_type_support_handle<rtabmap_msgs::srv::ListLabels>()
{
  ...
  auto service_type_support =
    &::rtabmap_msgs::srv::rosidl_typesupport_introspection_cpp::ListLabels_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, ListLabels)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rtabmap_msgs::srv::ListLabels>();
}
