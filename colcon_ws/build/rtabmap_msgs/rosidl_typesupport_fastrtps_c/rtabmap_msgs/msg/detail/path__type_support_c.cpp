...
#include "rtabmap_msgs/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
using _Path__ros_msg_type = rtabmap_msgs__msg__Path;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: node_ids
  {
    ...
    if (ros_message->node_ids.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->node_ids);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->node_ids, size)) {
      return "failed to create array for field 'node_ids'";
    }
    auto array_ptr = ros_message->node_ids.data;
...
static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_msgs__msg__Path(
...
{
  return max_serialized_size_rtabmap_msgs__msg__Path(
    full_bounded, 0);
}
