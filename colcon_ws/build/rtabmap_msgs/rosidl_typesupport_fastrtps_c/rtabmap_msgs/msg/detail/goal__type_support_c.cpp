...
#include "rtabmap_msgs/msg/detail/goal__rosidl_typesupport_fastrtps_c.h"
...
using _Goal__ros_msg_type = rtabmap_msgs__msg__Goal;
...
size_t get_serialized_size_rtabmap_msgs__msg__Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Goal__ros_msg_type * ros_message = static_cast<const _Goal__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_msgs__msg__Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
size_t max_serialized_size_rtabmap_msgs__msg__Goal(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_rtabmap_msgs__msg__Goal(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_msgs, msg, Goal)() {
