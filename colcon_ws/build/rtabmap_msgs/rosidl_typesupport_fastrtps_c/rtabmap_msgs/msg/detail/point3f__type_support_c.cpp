...
#include "rtabmap_msgs/msg/detail/point3f__rosidl_typesupport_fastrtps_c.h"
...
using _Point3f__ros_msg_type = rtabmap_msgs__msg__Point3f;
...
static uint32_t _Point3f__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_msgs__msg__Point3f(
...
{
  return max_serialized_size_rtabmap_msgs__msg__Point3f(
    full_bounded, 0);
}
