...
#include "rtabmap_msgs/msg/detail/map_graph__rosidl_typesupport_fastrtps_c.h"
...
#include "rtabmap_msgs/msg/detail/link__functions.h"  // links
...
using _MapGraph__ros_msg_type = rtabmap_msgs__msg__MapGraph;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: links
  {
    ...
    if (ros_message->links.data) {
      rtabmap_msgs__msg__Link__Sequence__fini(&ros_message->links);
    }
    if (!rtabmap_msgs__msg__Link__Sequence__init(&ros_message->links, size)) {
...
static uint32_t _MapGraph__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_msgs__msg__MapGraph(
...
{
  return max_serialized_size_rtabmap_msgs__msg__MapGraph(
    full_bounded, 0);
}
