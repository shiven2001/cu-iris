...
#include "rtabmap_msgs/msg/detail/env_sensor__rosidl_typesupport_fastrtps_c.h"
...
using _EnvSensor__ros_msg_type = rtabmap_msgs__msg__EnvSensor;
...
static uint32_t _EnvSensor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_msgs__msg__EnvSensor(
...
{
  return max_serialized_size_rtabmap_msgs__msg__EnvSensor(
    full_bounded, 0);
}
