...
{
  return max_serialized_size_rtabmap_msgs__srv__DetectMoreLoopClosures_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_rtabmap_msgs__srv__DetectMoreLoopClosures_Response(
    full_bounded, 0);
}
