...
static size_t _GetMap2_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rtabmap_msgs__srv__GetMap2_Request(
    full_bounded, 0);
}
...
static size_t _GetMap2_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_rtabmap_msgs__srv__GetMap2_Response(
    full_bounded, 0);
}
