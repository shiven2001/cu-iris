...
{
  return max_serialized_size_rtabmap_msgs__srv__GlobalBundleAdjustment_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_rtabmap_msgs__srv__GlobalBundleAdjustment_Response(
    full_bounded, 0);
}
