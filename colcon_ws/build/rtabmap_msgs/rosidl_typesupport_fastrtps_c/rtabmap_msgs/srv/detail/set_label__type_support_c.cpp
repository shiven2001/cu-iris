  ...
  void * untyped_ros_message)
{
  ...
  _SetLabel_Request__ros_msg_type * ros_message = static_cast<_SetLabel_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: node_id
  {
    cdr >> ros_message->node_id;
  }
...
{
  return max_serialized_size_rtabmap_msgs__srv__SetLabel_Request(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  _SetLabel_Response__ros_msg_type * ros_message = static_cast<_SetLabel_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
{
  return max_serialized_size_rtabmap_msgs__srv__SetLabel_Response(
    full_bounded, 0);
}
