  ...
  void * untyped_ros_message)
{
  ...
  _GetNodesInRadius_Request__ros_msg_type * ros_message = static_cast<_GetNodesInRadius_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: node_id
  {
    cdr >> ros_message->node_id;
  }
...
{
  return max_serialized_size_rtabmap_msgs__srv__GetNodesInRadius_Request(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  _GetNodesInRadius_Response__ros_msg_type * ros_message = static_cast<_GetNodesInRadius_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: ids
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  // Field name: dists_sqr
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->dists_sqr, size)) {
      return "failed to create array for field 'dists_sqr'";
    }
    auto array_ptr = ros_message->dists_sqr.data;
    cdr.deserializeArray(array_ptr, size);
  }
...
{
  return max_serialized_size_rtabmap_msgs__srv__GetNodesInRadius_Response(
    full_bounded, 0);
}
