...
rtabmap_msgs__srv__ListLabels_Request__create()
{
  ...
  rtabmap_msgs__srv__ListLabels_Request * msg = (rtabmap_msgs__srv__ListLabels_Request *)allocator.allocate(sizeof(rtabmap_msgs__srv__ListLabels_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rtabmap_msgs__srv__ListLabels_Request));
  bool success = rtabmap_msgs__srv__ListLabels_Request__init(msg);
  if (!success) {
...
rtabmap_msgs__srv__ListLabels_Request__destroy(rtabmap_msgs__srv__ListLabels_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rtabmap_msgs__srv__ListLabels_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rtabmap_msgs__srv__ListLabels_Request__Sequence__init(rtabmap_msgs__srv__ListLabels_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_msgs__srv__ListLabels_Request * data = NULL;

  if (size) {
    data = (rtabmap_msgs__srv__ListLabels_Request *)allocator.zero_allocate(size, sizeof(rtabmap_msgs__srv__ListLabels_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rtabmap_msgs__srv__ListLabels_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rtabmap_msgs__srv__ListLabels_Request__fini(&data[i - 1]);
      }
...
rtabmap_msgs__srv__ListLabels_Request__Sequence__fini(rtabmap_msgs__srv__ListLabels_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rtabmap_msgs__srv__ListLabels_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_msgs__srv__ListLabels_Request__Sequence * array = (rtabmap_msgs__srv__ListLabels_Request__Sequence *)allocator.allocate(sizeof(rtabmap_msgs__srv__ListLabels_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rtabmap_msgs__srv__ListLabels_Request__Sequence__init(array, size);
  if (!success) {
...
rtabmap_msgs__srv__ListLabels_Request__Sequence__destroy(rtabmap_msgs__srv__ListLabels_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rtabmap_msgs__srv__ListLabels_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rtabmap_msgs__srv__ListLabels_Request__Sequence__are_equal(const rtabmap_msgs__srv__ListLabels_Request__Sequence * lhs, const rtabmap_msgs__srv__ListLabels_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_msgs__srv__ListLabels_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rtabmap_msgs__srv__ListLabels_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_msgs__srv__ListLabels_Request);
    rtabmap_msgs__srv__ListLabels_Request * data =
      (rtabmap_msgs__srv__ListLabels_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_msgs__srv__ListLabels_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rtabmap_msgs__srv__ListLabels_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rtabmap_msgs__srv__ListLabels_Request__copy(
...
rtabmap_msgs__srv__ListLabels_Response__init(rtabmap_msgs__srv__ListLabels_Response * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->ids, 0)) {
    rtabmap_msgs__srv__ListLabels_Response__fini(msg);
    return false;
  }
  // labels
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_msgs__srv__ListLabels_Response * msg = (rtabmap_msgs__srv__ListLabels_Response *)allocator.allocate(sizeof(rtabmap_msgs__srv__ListLabels_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rtabmap_msgs__srv__ListLabels_Response));
  bool success = rtabmap_msgs__srv__ListLabels_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rtabmap_msgs__srv__ListLabels_Response__Sequence__init(rtabmap_msgs__srv__ListLabels_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_msgs__srv__ListLabels_Response * data = NULL;

  if (size) {
    data = (rtabmap_msgs__srv__ListLabels_Response *)allocator.zero_allocate(size, sizeof(rtabmap_msgs__srv__ListLabels_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rtabmap_msgs__srv__ListLabels_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rtabmap_msgs__srv__ListLabels_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rtabmap_msgs__srv__ListLabels_Response__Sequence__fini(rtabmap_msgs__srv__ListLabels_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rtabmap_msgs__srv__ListLabels_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_msgs__srv__ListLabels_Response__Sequence * array = (rtabmap_msgs__srv__ListLabels_Response__Sequence *)allocator.allocate(sizeof(rtabmap_msgs__srv__ListLabels_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rtabmap_msgs__srv__ListLabels_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rtabmap_msgs__srv__ListLabels_Response__Sequence__destroy(rtabmap_msgs__srv__ListLabels_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rtabmap_msgs__srv__ListLabels_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rtabmap_msgs__srv__ListLabels_Response__Sequence__are_equal(const rtabmap_msgs__srv__ListLabels_Response__Sequence * lhs, const rtabmap_msgs__srv__ListLabels_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_msgs__srv__ListLabels_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rtabmap_msgs__srv__ListLabels_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_msgs__srv__ListLabels_Response);
    rtabmap_msgs__srv__ListLabels_Response * data =
      (rtabmap_msgs__srv__ListLabels_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_msgs__srv__ListLabels_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rtabmap_msgs__srv__ListLabels_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rtabmap_msgs__srv__ListLabels_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
