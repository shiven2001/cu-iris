...
static rosidl_typesupport_introspection_c__MessageMember Info__rosidl_typesupport_introspection_c__Info_message_member_array[22] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, msg, Info)() {
  Info__rosidl_typesupport_introspection_c__Info_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  Info__rosidl_typesupport_introspection_c__Info_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Transform)();
  Info__rosidl_typesupport_introspection_c__Info_message_member_array[21].members_ =
