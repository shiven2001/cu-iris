...
size_t GetNodeData_Response__rosidl_typesupport_introspection_c__size_function__Node__data(
...
const void * GetNodeData_Response__rosidl_typesupport_introspection_c__get_const_function__Node__data(
...
void * GetNodeData_Response__rosidl_typesupport_introspection_c__get_function__Node__data(
...
bool GetNodeData_Response__rosidl_typesupport_introspection_c__resize_function__Node__data(
...
static rosidl_typesupport_introspection_c__MessageMember GetNodeData_Response__rosidl_typesupport_introspection_c__GetNodeData_Response_message_member_array[1] = {
  {
    ...
    NULL,  // default value
    GetNodeData_Response__rosidl_typesupport_introspection_c__size_function__Node__data,  // size() function pointer
    GetNodeData_Response__rosidl_typesupport_introspection_c__get_const_function__Node__data,  // get_const(index) function pointer
    GetNodeData_Response__rosidl_typesupport_introspection_c__get_function__Node__data,  // get(index) function pointer
    GetNodeData_Response__rosidl_typesupport_introspection_c__resize_function__Node__data  // resize(index) function pointer
  }
};
