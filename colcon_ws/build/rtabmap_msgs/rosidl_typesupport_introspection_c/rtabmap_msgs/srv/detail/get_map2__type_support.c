...
void GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_init_function(
...
void GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_fini_function(void * message_memory)
{
  rtabmap_msgs__srv__GetMap2_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_message_member_array[8] = {
  {
    "global_map",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_message_members = {
  "rtabmap_msgs__srv",  // message namespace
  "GetMap2_Request",  // message name
  8,  // number of fields
  sizeof(rtabmap_msgs__srv__GetMap2_Request),
  GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_message_member_array,  // message members
  GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_message_type_support_handle = {
  0,
  &GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, GetMap2_Request)() {
  if (!GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_message_type_support_handle.typesupport_identifier) {
    GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetMap2_Request__rosidl_typesupport_introspection_c__GetMap2_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_fini_function(void * message_memory)
{
  rtabmap_msgs__srv__GetMap2_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_member_array[1] = {
  {
    "data",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_members = {
  "rtabmap_msgs__srv",  // message namespace
  "GetMap2_Response",  // message name
  1,  // number of fields
  sizeof(rtabmap_msgs__srv__GetMap2_Response),
  GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_member_array,  // message members
  GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_type_support_handle = {
  0,
  &GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, GetMap2_Response)() {
  GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, msg, MapData)();
  if (!GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_type_support_handle.typesupport_identifier) {
    GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetMap2_Response__rosidl_typesupport_introspection_c__GetMap2_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
