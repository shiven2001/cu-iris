...
#include <stddef.h>
#include "rtabmap_msgs/srv/detail/get_nodes_in_radius__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rtabmap_msgs__srv__GetNodesInRadius_Request__init(message_memory);
}
...
{
  rtabmap_msgs__srv__GetNodesInRadius_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GetNodesInRadius_Request__rosidl_typesupport_introspection_c__GetNodesInRadius_Request_message_member_array[6] = {
  {
    ...
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Request, node_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Request, x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Request, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Request, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Request, radius),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Request, k),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GetNodesInRadius_Request__rosidl_typesupport_introspection_c__GetNodesInRadius_Request_message_members = {
  ...
  6,  // number of fields
  sizeof(rtabmap_msgs__srv__GetNodesInRadius_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, GetNodesInRadius_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  rtabmap_msgs__srv__GetNodesInRadius_Response__init(message_memory);
}
...
{
  rtabmap_msgs__srv__GetNodesInRadius_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GetNodesInRadius_Response__rosidl_typesupport_introspection_c__GetNodesInRadius_Response_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Response, ids),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Response, poses),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__GetNodesInRadius_Response, dists_sqr),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GetNodesInRadius_Response__rosidl_typesupport_introspection_c__GetNodesInRadius_Response_message_members = {
  ...
  3,  // number of fields
  sizeof(rtabmap_msgs__srv__GetNodesInRadius_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rtabmap_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, GetNodesInRadius_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_service_members = {
  "rtabmap_msgs__srv",  // service namespace
  "GetNodesInRadius",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_Request_message_type_support_handle,
  NULL  // response message
  // rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_Response_message_type_support_handle
};

static rosidl_service_type_support_t rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_service_type_support_handle = {
  0,
  &rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, GetNodesInRadius)() {
  if (!rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_service_type_support_handle.typesupport_identifier) {
    rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, GetNodesInRadius_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, GetNodesInRadius_Response)()->data;
  }

  return &rtabmap_msgs__srv__detail__get_nodes_in_radius__rosidl_typesupport_introspection_c__GetNodesInRadius_service_type_support_handle;
}
