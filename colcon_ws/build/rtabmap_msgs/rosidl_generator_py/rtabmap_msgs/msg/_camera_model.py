...
class Metaclass_CameraModel(type):
    """Metaclass of message 'CameraModel'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__camera_model
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__camera_model
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__camera_model
            cls._TYPE_SUPPORT = module.type_support_msg__msg__camera_model
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__camera_model
...
class CameraModel(metaclass=Metaclass_CameraModel):
    """Message class 'CameraModel'."""
    ...
    _fields_and_field_types = {
        ...
        'local_transform': 'geometry_msgs/Transform',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Transform
        self.local_transform = kwargs.get('local_transform', Transform())
    ...
    def local_transform(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'local_transform' field must be a sub message of type 'Transform'"
