...
#include "rtabmap_msgs/msg/detail/path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_msgs::msg::Path & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::msg::Path & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: node_ids
  {
    ...
    size_t item_size = sizeof(ros_message.node_ids[0]);
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, msg, Path)() {
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
