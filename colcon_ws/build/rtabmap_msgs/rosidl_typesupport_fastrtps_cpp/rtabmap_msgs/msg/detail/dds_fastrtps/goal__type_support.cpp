...
#include "rtabmap_msgs/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_msgs::msg::Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::msg::Goal & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::msg::Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::msg::Goal *>(
    untyped_ros_message);
...
static size_t _Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Goal(full_bounded, 0);
}
...
{
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, msg, Goal)() {
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
