...
#include "rtabmap_msgs/msg/detail/point3f__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::msg::Point3f *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::msg::Point3f *>(
    untyped_ros_message);
...
{
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_Point3f__handle;
}
