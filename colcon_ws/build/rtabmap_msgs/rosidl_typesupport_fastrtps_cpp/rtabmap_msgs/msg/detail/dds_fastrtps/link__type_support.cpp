...
#include "rtabmap_msgs/msg/detail/link__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_msgs::msg::Link & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::msg::Link & ros_message)
{
  // Member: from_id
  cdr >> ros_message.from_id;
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::msg::Link *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::msg::Link *>(
    untyped_ros_message);
...
{
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_Link__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, msg, Link)() {
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_Link__handle;
}
