...
#include "rtabmap_msgs/msg/detail/global_descriptor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_msgs::msg::GlobalDescriptor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::msg::GlobalDescriptor & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: info
  {
    ...
    size_t item_size = sizeof(ros_message.info[0]);
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::msg::GlobalDescriptor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::msg::GlobalDescriptor *>(
    untyped_ros_message);
...
{
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_GlobalDescriptor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, msg, GlobalDescriptor)() {
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_GlobalDescriptor__handle;
}
