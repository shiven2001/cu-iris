...
#include "rtabmap_msgs/msg/detail/landmark_detections__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_msgs::msg::LandmarkDetections & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::msg::LandmarkDetections & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_msgs
max_serialized_size_LandmarkDetections(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::msg::LandmarkDetections *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::msg::LandmarkDetections *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LandmarkDetections__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rtabmap_msgs::msg::LandmarkDetections *>(
...
static size_t _LandmarkDetections__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_LandmarkDetections(full_bounded, 0);
}

static message_type_support_callbacks_t _LandmarkDetections__callbacks = {
  "rtabmap_msgs::msg",
  "LandmarkDetections",
...
static rosidl_message_type_support_t _LandmarkDetections__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LandmarkDetections__callbacks,
...
{
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_LandmarkDetections__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, msg, LandmarkDetections)() {
  return &rtabmap_msgs::msg::typesupport_fastrtps_cpp::_LandmarkDetections__handle;
}
