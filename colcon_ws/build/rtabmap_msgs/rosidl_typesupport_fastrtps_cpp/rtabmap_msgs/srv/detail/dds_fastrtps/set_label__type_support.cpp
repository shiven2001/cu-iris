...
#include "rtabmap_msgs/srv/detail/set_label__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_msgs::srv::SetLabel_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::srv::SetLabel_Request & ros_message)
{
  // Member: node_id
  cdr >> ros_message.node_id;
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::srv::SetLabel_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::srv::SetLabel_Request *>(
    untyped_ros_message);
...
{
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_SetLabel_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, SetLabel_Request)() {
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_SetLabel_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_msgs
cdr_serialize(
  const rtabmap_msgs::srv::SetLabel_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::srv::SetLabel_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::srv::SetLabel_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::srv::SetLabel_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_SetLabel_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, SetLabel_Response)() {
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_SetLabel_Response__handle;
}
...
{
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_SetLabel__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, SetLabel)() {
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_SetLabel__handle;
}
