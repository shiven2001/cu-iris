...
#include "rtabmap_msgs/srv/detail/add_link__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_msgs::srv::AddLink_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::srv::AddLink_Request & ros_message)
{
  // Member: link
  ...
  size_t current_alignment)
{
  ...
  // Member: link
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Link(
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::srv::AddLink_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::srv::AddLink_Request *>(
    untyped_ros_message);
...
{
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_AddLink_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, AddLink_Request)() {
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_AddLink_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_msgs
cdr_serialize(
  const rtabmap_msgs::srv::AddLink_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs::srv::AddLink_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const rtabmap_msgs::srv::AddLink_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rtabmap_msgs::srv::AddLink_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_AddLink_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, AddLink_Response)() {
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_AddLink_Response__handle;
}
...
{
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_AddLink__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, AddLink)() {
  return &rtabmap_msgs::srv::typesupport_fastrtps_cpp::_AddLink__handle;
}
