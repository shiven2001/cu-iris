...
: ${AMENT_CURRENT_PREFIX:="/home/shiven/colcon_ws/install/orbslam3"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/orbslam3/environment/pythonpath.sh"
